...
Cualquier pregunta sobre el uso de errores técnicos o de AEM que pueda tener debe notificarse a través del proceso de soporte normal a través del [Portal de Soporte al Cliente de Experience Cloud](https://experienceleague.adobe.com/?support-solution=Experience+Manager#support) o discutirse en la [comunidad de Experience Manager](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community).
