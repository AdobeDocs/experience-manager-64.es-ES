...
description: Obtenga información sobre los ajustes de configuración avanzados que se aplican a la integración de AEM 3D tanto para implementaciones Maya como no Maya.
seo-description: Obtenga información sobre los ajustes de configuración avanzados que se aplican a la integración de AEM 3D tanto para implementaciones Maya como no Maya.
...
Los siguientes ajustes de configuración avanzados se aplican a la integración de AEM 3D tanto para implementaciones Maya como no Maya.

Se puede acceder a todos los ajustes mediante **CRXDE Lite** en AEM (**[!UICONTROL Herramientas > General > CRXDE Lite]**).
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Permite la generación de una sombra paralela de oclusión ambiental cuando se visualiza o procesa con un escenario IBL. Se aplica a la vista previa y el procesamiento con RapidRefine</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>Especifica cuántas CPU se utilizan como máximo para el procesamiento de ingestión de recursos 3D.</p> <p>Los valores más altos aceleran las ingestas, pero pueden hacer que AEM sea menos receptiva en general. Esta configuración es aproximada. Es decir, la precisión aumenta con el número de núcleos de CPU disponibles.</p> </td> 
  </tr> 
 </tbody> 
</table>

## Configuración de servicios de nube {#cloud-services-configuration-settings}

El administrador de cuentas de Adobe, el experto en aprovisionamiento o el representante de asistencia técnica proporcionan los valores para las siguientes opciones de configuración.
...
| `/libs/settings/dam/v3D/renderers/*/MaxCpuPercentage` | Especifica cuántas CPU se utilizan como máximo para procesar escenas 3D. Los valores más altos aceleran el procesamiento, pero pueden hacer que AEM sea menos receptivo en general. Esta configuración es aproximada. Es decir, la precisión aumenta con el número de núcleos de CPU disponibles. |

## Ajustes de vista previa de recursos 3D {#d-asset-preview-settings}
...
| `/libs/settings/dam/v3D/WebGL/curtainColor` | Especifica el color de la cortina de carga que puede, opcionalmente, cubrir la ventanilla móvil de la vista previa de recursos 3D durante la carga y la inicialización. Valor R,G,B, con cada componente de color en el rango de 0 a 255. |
...
| `/libs/settings/dam/v3D/WebGL/showCurtains` | Establezca en **[!UICONTROL true]** o **[!UICONTROL false]** para habilitar o deshabilitar la cortina de carga para la vista previa de recursos 3D. |
