...
La integración requiere un [plan empresarial de Adobe Stock](https://stockenterprise.adobe.com/) y [!DNL Experience Manager] 6.4 con al menos Service Pack 2 implementado. Para obtener [!DNL Experience Manager] detalles del Service Pack 6.4, consulte estas [notas de la versión](/help/release-notes/sp-release-notes.md).
...
1. Haga clic en **[!UICONTROL Crear nuevo proyecto]** y haga clic en **[!UICONTROL Añadir API]**. Seleccione **[!UICONTROL Adobe Stock]** de la lista de API que están [!UICONTROL disponibles para usted]. Seleccione [!UICONTROL OAUTH 2.0 Web]. Configure y copie los distintos valores presentados.
...
1. En la interfaz de usuario [!DNL Experience Manager], vaya a **[!UICONTROL Herramientas]** > **[!UICONTROL Cloud Services]** > **[!UICONTROL Adobe Stock]**.
...
>[!NOTE]
>
>Si hay varias configuraciones [!DNL Adobe Stock], seleccione la configuración deseada en el panel Preferencias del usuario (**[!UICONTROL AEM]** > **[!UICONTROL Icono del usuario]** > **[!UICONTROL Preferencias del usuario]** > **[!UICONTROL Configuración de almacenamiento]**).
