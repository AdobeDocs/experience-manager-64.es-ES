---
title: Uso de recursos de Adobe Stock en AEM Assets
...
>[!NOTE]
>
>Si hay varias configuraciones de Adobe Stock, seleccione la configuración deseada en el panel Preferencias de usuario (**[!UICONTROL AEM]** > Icono **** de usuario > Preferencias **** de usuario > Configuración **[!UICONTROL de almacenamiento]**).

## Uso y gestión de recursos de Adobe Stock en AEM {#use-and-manage-adobe-stock-assets-in-aem}
...
*Figura: Busque recursos de Adobe Stock y filtre los resultados del espacio de trabajo de AEM*
...
* Para buscar recursos en Adobe Stock y AEM Assets, haga clic en el icono de búsqueda ![search_icon](assets/search_icon.png).
...
>[!NOTE]
>
>Los recursos que se buscan desde Adobe Stock solo se muestran en AEM. Los recursos de Adobe Stock se recuperan y almacenan en el repositorio de AEM solo después de que un usuario [guarde un recurso](aem-assets-adobe-stock.md#saveassets) o [conceda una licencia a un recurso](aem-assets-adobe-stock.md#licenseassets). Los recursos que ya están almacenados en AEM se muestran y resaltan para facilitar la referencia y el acceso. Además, estos recursos se guardan con algunos metadatos adicionales para indicar el origen como Adobe Stock.
...
![Cuadro de diálogo para obtener la licencia y guardar los recursos de Adobe Stock en AEM Assets](assets/aem-stock_licenseandsave.jpg)

*Figura: Cuadro de diálogo para obtener la licencia y guardar los recursos de Adobe Stock en AEM Assets*
