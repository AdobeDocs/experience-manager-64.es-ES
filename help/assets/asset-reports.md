...
1. En la página **[!UICONTROL Crear informe]**, elija el informe que desee crear y haga clic en **[!UICONTROL Siguiente]**.
   ...
   >[!NOTE]
   >
   >De forma predeterminada, los fragmentos de contenido y los vínculos compartidos se incluyen en el [!UICONTROL informe descargado] del recurso. Seleccione la opción adecuada para crear un informe de vínculos compartidos o para excluir fragmentos de contenido del informe de descarga.

   >[!NOTE]
   >
   >El informe [!UICONTROL Download] muestra detalles de solo los recursos que se seleccionan de forma individual y se descargan o descargan mediante Acción rápida. Sin embargo, no incluye los detalles de los recursos que estaban dentro de una carpeta descargada.
