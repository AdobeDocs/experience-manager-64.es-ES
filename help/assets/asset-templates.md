...
1. (Opcional) Toque o haga clic en el icono **[!UICONTROL Etiquetas]** situado junto al campo **[!UICONTROL Etiquetas]** y seleccione una o varias etiquetas para el folleto. Toque o haga clic en **[!UICONTROL Confirmar]** para confirmar la selección.
...
1. Para abrir el material publicitario para la edición, realice una de las siguientes acciones:
   ...
   * Abra el material publicitario (en este caso, el folleto) que ha creado en el paso 7 de [Creación de una garantía](asset-templates.md#creating-a-collateral).
...
1. Click/tap **[!UICONTROL Save]** and then click/tap **[!UICONTROL OK]** in the dialog to close the dialog. El colateral de varias páginas se crea en la carpeta en la que se inició.
