...
Además de utilizar componentes de editor preexistentes, los desarrolladores de Adobe Experience Manager también pueden crear sus propios componentes.
...
[!DNL Experience Manager Assets] los componentes utilizan una extensión de WCM edit clientlib. Los clientlibs suelen cargarse en `init.jsp`.
...
Algunos de los [!DNL Assets] los componentes utilizan la variable [!DNL Experience Manager] biblioteca de widgets. Para que se represente correctamente en el contexto de contenido, se debe cargar una hoja de estilo adicional. El componente de acción de etiqueta requiere uno más.
