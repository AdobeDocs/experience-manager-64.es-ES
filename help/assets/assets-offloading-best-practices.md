...
# Optimizaciones para la descarga de recursos {#assets-offloading-best-practices}
...
El administrador de trabajos distribuye nuevos trabajos a instancias de trabajador. Al diseñar el mecanismo de distribución, es importante tener en cuenta la habilitación de temas. Los trabajos solo se pueden asignar a instancias en las que el tema del trabajo está activado. Deshabilite el tema `com/adobe/granite/workflow/offloading` en el primario y habilite el trabajo en el trabajador para asegurarse de que el trabajo está asignado al trabajador.
...
Una vez que se escribe un trabajo en el trabajador, el administrador de trabajos llama al consumidor del trabajo responsable del tema *com/adobe/granite/workflow/offloading*. A continuación, el consumidor del trabajo ejecuta el flujo de trabajo de recursos de actualización de DAM en el recurso.

## Topología sling {#sling-topology}
...
### Sling ha distribuido trabajos {#sling-distributed-jobs}
...
## Guía general y prácticas recomendadas para la descarga de activos {#general-guidance-and-best-practices-for-asset-offloading}
...
### Uso de replicación avanzada {#using-forward-replication}
...
De forma predeterminada, el flujo de trabajo de descarga *de descarga de recursos de actualización de DAM* agrega el modelo de flujo de trabajo para llamar al trabajador a la carga útil del trabajo. Debido a que este flujo de trabajo sigue el modelo predeterminado *Recurso de actualización de DAM*, esta carga útil adicional se puede eliminar.
