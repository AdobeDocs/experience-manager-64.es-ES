...
1. (Opcional) En el editor de esquemas de metadatos, cree un nuevo campo para condicionalizar. Especifique un nombre y una ruta de acceso de propiedad en la variable **[!UICONTROL Configuración]** pestaña .
   ...
   Para crear una pestaña nueva, toque o haga clic en **[!UICONTROL +]** para agregar una pestaña y, a continuación, agregar un campo de metadatos.
...
1. Repita los pasos para crear dependencia entre los recursos del documento (PDF y Word) en la **[!UICONTROL Tipo de recurso]** campos y campos como Recuento de páginas y Autor.
