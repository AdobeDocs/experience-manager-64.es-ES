...
1. (Opcional) En el editor de esquemas de metadatos, cree un nuevo campo para condicionalizar. Especifique un nombre y una ruta de propiedad en la ficha **[!UICONTROL Configuración]**.
   ...
   Para crear una nueva ficha, toque o haga clic en **[!UICONTROL +]** para agregar una ficha y, a continuación, agregue un campo de metadatos.
...
1. Repita los pasos para crear dependencia entre los recursos de documento (PDF y Word) en el campo **[!UICONTROL Tipo de recurso]** y campos como Recuento de páginas y Autor.
