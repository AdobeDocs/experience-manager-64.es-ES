...
1. Contacto [!UICONTROL Asistencia al cliente] para obtener el paquete de correcciones extendido (EFP) para la migración a perfiles empresariales. Instale el EFP en su instancia de Experience Manager.
