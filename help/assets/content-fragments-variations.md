...
[Las ](content-fragments.md#constituent-parts-of-a-content-fragment) variaciones son una característica importante de los fragmentos de contenido, ya que permiten crear y editar copias del contenido principal para utilizarlas en canales o escenarios específicos.
...
>[!NOTE]
>
>Para obtener más información, consulte la documentación de [Markdown](content-fragments-markdown.md).
...
1. Seleccione **[!UICONTROL Maestro]** o la variación requerida.
...
* Puede enumerarse y eliminarse seleccionando la ficha **[!UICONTROL Anotaciones]** en el editor de fragmentos.
...
>[!NOTE]
>
>Existen varios métodos para agregar [imágenes](content-fragments.md#fragments-with-visual-assets) al fragmento o a la página.
...
1. Seleccione **[!UICONTROL Cambiar nombre]** en la lista desplegable **[!UICONTROL Acciones]**.
...
1. Abra el fragmento y seleccione **[!UICONTROL Variaciones]** en el panel lateral.
1. Seleccione la variación requerida.
1. Seleccione **[!UICONTROL Eliminar]** en la lista desplegable **[!UICONTROL Acciones]**.
...
3. El patrón y la variación se mostrarán en paralelo:
