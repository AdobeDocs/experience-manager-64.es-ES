...
* Seleccione el [formato](#formats) (Texto[](#rich-text)enriquecido, Texto [](#plain-text)sin formato, [Marcado](#markdown))
...
* [Resumir texto](#summarizing-text)
* [Anotar](content-fragments-variations.md#annotating-a-content-fragment) el texto
...
* Se puede enumerar y eliminar seleccionando la ficha **[!UICONTROL Anotaciones]** en el editor de fragmentos.

   ![cfm-6420-25](assets/cfm-6420-25.png)

* Se puede ver y eliminar en la [línea de tiempo](https://helpx.adobe.com/experience-manager/6-3/assets/using/content-fragments-managing.html#timeline-for-content-fragments) del fragmento seleccionado.

### Inserción de recursos en el fragmento {#inserting-assets-into-your-fragment}

Para facilitar el proceso de creación de fragmentos de contenido, puede añadir [Recursos](managing-assets-touch-ui.md) (imágenes) directamente al fragmento.
