...
1. En la consola Recursos, haga clic en el icono **Buscar** de la barra de herramientas para mostrar el cuadro de búsqueda Omni.
...
1. Para buscar recursos en función de su estado, toque o haga clic en el icono **[!UICONTROL Buscar]** para mostrar la barra de búsqueda de Omni.
...
>[!NOTE]
>
>La ubicación */etc/dam/drm/license* utilizada para almacenar licencias en versiones anteriores de AEM está en desuso.
>
>Si crea o modifica páginas de licencia o las transfiere desde versiones anteriores de AEM, Adobe recomienda almacenarlas en */apps/settings/dam/drm/licencias* o */conf/&amp;ast;/settings/dam/drm/licencias*.
