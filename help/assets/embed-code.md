...
seo-title: Incrustación del visor de vídeo o de imagen de Dynamic Media en una página web
description: Aprenda a incrustar vídeos o imágenes de Dynamic Media en una página web
seo-description: Aprenda a incrustar vídeo o imágenes de Dynamic Media en una página web
...
# Incrustación del visor de imágenes o vídeo de Dynamic Media en una página web {#embedding-the-video-or-image-viewer-on-a-web-page}
...
**Para incrustar el visor de vídeo o imagen de Dynamic Media en una página** web:
