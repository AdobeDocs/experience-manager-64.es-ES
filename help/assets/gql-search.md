...
1. En la barra de herramientas de la interfaz de usuario de Recursos, toque o haga clic en el icono **[!UICONTROL Buscar]** para mostrar el cuadro de búsqueda de Omniture.
...
1. Pulse **[!UICONTROL Intro]**. La interfaz de usuario de AEM Assets solo muestra los recursos cuyo título coincide exactamente con &quot;Destinatario&quot;.
...
| [!UICONTROL Propietario del copyright] | copyrightowner:&quot;Adobe Systems&quot; |
| [!UICONTROL Colaborador] | colaborador:John |
...
1. Cambie a la ficha **[!UICONTROL Avanzado]** y toque o haga clic **[!UICONTROL Añadir]** en **[!UICONTROL Elevar para palabras clave de búsqueda]**.

   ![elevate_for_search](assets/elevate_for_search.png)

1. En el cuadro **[!UICONTROL Promocionar búsqueda]**, especifique una palabra clave para la que desee impulsar la búsqueda de la imagen y, a continuación, toque o haga clic **[!UICONTROL Añadir]**. En caso necesario, especifique varias palabras clave de la misma manera.
