...
Cuando agrega un recorte inteligente a un perfil de imagen existente, debe volver a déclencheur el [flujo de trabajo de recursos de actualización de DAM](assets-workflow.md) si desea generar cultivos para los recursos existentes en el repositorio de recursos.
