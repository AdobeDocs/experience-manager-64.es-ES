...
Para instalar y inicio de InDesign Server para utilizarlo con AEM:
...
1. Para activar la compatibilidad con varias sesiones para Adobe CS6 y versiones posteriores, marque la `enable.multisession.name` casilla de verificación situada debajo de `com.day.cq.dam.ids.impl.IDSJobProcessor.name configuration`.
