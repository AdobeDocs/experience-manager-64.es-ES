...
* Para ver todas las solicitudes HTTP salientes en Google Chrome, pulse F12 para abrir el panel **[!UICONTROL Herramientas para desarrolladores]** y, a continuación, haga clic en la ficha **[!UICONTROL Red]**.
