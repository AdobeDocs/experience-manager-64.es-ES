---
title: API HTTP de Assets en [!DNL Adobe Experience Manager].
...
La API HTTP de recursos permite crear, leer, actualizar y eliminar operaciones (CRUD) en recursos digitales, incluidos metadatos, representaciones y comentarios, junto con contenido estructurado mediante [!DNL Experience Manager] Fragmentos de contenido. Está expuesto en `/api/assets` y se implementa como API de REST.
