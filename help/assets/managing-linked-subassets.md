---
title: 'Administrar recursos compuestos y '
description: Aprenda a crear referencias a recursos de AEM desde archivos de InDesign, Adobe Illustrator y Photoshop. Aprenda también a utilizar la función Visor de páginas para ver páginas individuales de archivos de varias páginas, incluidos archivos PDF, INDD, PPT, PPTX y Ai.
contentOwner: AG
...
1. Haga clic en el icono **[!UICONTROL Ver propiedades]** de la barra de herramientas. En la página de propiedades, la lista de archivos que hacen referencia al recurso actual aparece en la columna **[!UICONTROL Referencias]** de la ficha **[!UICONTROL Básico]** .
...
1. Los recursos a los que se hace referencia también contienen la lista de recursos desde los que se hace referencia. Para ver una lista de recursos a los que se hace referencia, vaya a la página de detalles del recurso y cierre el [carril](/help/sites-authoring/basic-handling.md#rail-selector).
