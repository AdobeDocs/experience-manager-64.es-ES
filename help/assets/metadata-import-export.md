...
1. En la página **[!UICONTROL Importación de metadatos]**, toque o haga clic en **[!UICONTROL Seleccionar archivo]**.  Seleccione el archivo CSV con los metadatos.
1. Asegúrese de que el archivo CSV contenga los parámetros siguientes:
   ...
   | [!UICONTROL Lanzar flujos de trabajo] | False de forma predeterminada. Cuando se establece en true y la configuración predeterminada del iniciador está en vigor para `DAM Metadata WriteBack Workflow` (que escribe metadatos en los datos de XMP binarios). La activación de flujos de trabajo de inicio tiene un impacto en el rendimiento del sistema. |
...
1. En las **[!UICONTROL Propiedades que se van a exportar]**, especifique si desea exportar todas las propiedades o determinadas. Si elige **[!UICONTROL Propiedades selectivas]** para exportar, agregue las propiedades que desee.
