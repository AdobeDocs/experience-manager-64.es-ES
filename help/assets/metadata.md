...
Los campos de metadatos definidos por Exif suelen ser de naturaleza técnica y su uso es limitado para la administración de metadatos descriptivos. Por este motivo, [!DNL Experience Manager Assets] ofrece la asignación de propiedades Exif en [esquemas de metadatos comunes](metadata-schemas.md) y [XMP](xmp-writeback.md).
...
* DEX - [Explorador de descripciones de Optima SC](http://www.optimasc.com/products/dex/index.html) es una colección de herramientas para la administración de archivos y metadatos para sistemas operativos Windows.
...
* PRISM - [Requisitos de publicación para los metadatos estándar del sector](https://idealliance.org/specifications/prism-metadata/).
* XMP - [!DNL Extensible Metadata Platform].
