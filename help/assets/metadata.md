...
* las imágenes relacionadas o las etiquetas aplicadas
...
Existen dos tipos básicos de metadatos:
...
AEM le proporciona una lista lista lista lista para usar de los esquemas de metadatos más populares, que le permite empezar rápidamente la estrategia de metadatos y elegir las propiedades de metadatos que necesita de un esquema ya definido.
