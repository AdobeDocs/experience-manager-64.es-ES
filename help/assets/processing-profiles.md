...
>[!NOTE]
>
>Se aplica a Medios *dinámicos: modo* Scene7 solo en AEM 6.4.7.0 o posterior.
...
1. En la esquina superior derecha del Scene7: Volver a procesar la página del modelo de flujo de trabajo de Recursos, toque **[!UICONTROL Sincronizar]**. Cuando se ve **[!UICONTROL Sincronizado]**, el modelo de tiempo de ejecución del flujo de trabajo se sincroniza correctamente y está listo para volver a procesar el recurso en una carpeta.
