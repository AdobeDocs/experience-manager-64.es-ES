...
1. Seleccione los recursos que desea desrelacionar en el cuadro de diálogo **[!UICONTROL Eliminar relaciones]** y toque o haga clic **[!UICONTROL Desrelacionar]**.

   ![chlimage_1-280](assets/chlimage_1-280.png)

1. Haga clic o toque **[!UICONTROL Aceptar]** para cerrar el cuadro de diálogo. Los recursos para los que ha eliminado relaciones se eliminan de la lista de recursos relacionados en la sección **[!UICONTROL Relacionado]**.
...
1. Seleccione el recurso y, a continuación, toque o haga clic **[!UICONTROL Mostrar en recursos]** en la barra de herramientas para vista del estado de traducción del recurso.
...
1. Seleccione el recurso relacionado con el origen y, a continuación, toque o haga clic **[!UICONTROL Mostrar en recursos]**. Se muestra el recurso relacionado traducido.
