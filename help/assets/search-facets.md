...
1. En la página Buscar en Forms, seleccione **[!UICONTROL Raíl de búsqueda de administración de recursos]** y luego toque **Editar** ![aemassets_edit](assets/aemassets_edit.png).
   ...
   >[!NOTE]
   >
   >Para utilizar la funcionalidad de búsqueda de carpetas desde el **Raíl de búsqueda de administración de recursos** preconfigurado desde una versión anterior de AEM, lleve a cabo estos pasos:
   > 
...
1. Toque o haga clic en la **[!UICONTROL Previsualización]** ![previsualización](assets/preview.png) para generar una previsualización del panel Filtros tal como aparece después de agregar el predicado.
...
1. Toque el logotipo de AEM y, a continuación, vaya a **[!UICONTROL Herramientas > General > Buscar en Forms]**.
...
1. En la página Buscar en Forms, seleccione **[!UICONTROL Raíl de búsqueda de administración de recursos]**, toque **Editar** ![aemassets_edit](assets/aemassets_edit.png).
...
1. En el campo **Descripción**, introduzca una descripción opcional y toque **[!UICONTROL Listo]**.
...
1. En el campo **[!UICONTROL Descripción]**, introduzca una descripción opcional y toque o haga clic **[!UICONTROL Listo]**.
...
De forma predeterminada, aparece un icono Bloquear antes de **[!UICONTROL Raíl de búsqueda de administración de recursos]** en la página **[!UICONTROL Buscar en Forms]**. El icono Bloquear desaparece si agrega facetas de búsqueda al formulario que indican que se ha modificado el formulario predeterminado.
...
| [!UICONTROL Vista previa] | Permisos de lectura, escritura y eliminación en el nodo /var/dam/content de CRX. También tiene permisos de lectura y escritura en el nodo /apps. |
