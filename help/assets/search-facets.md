...
1. Toque o haga clic en el botón [!DNL Experience Manager] y, a continuación, vaya a **[!UICONTROL Herramientas]** > **[!UICONTROL General]** > **[!UICONTROL Buscar en Forms]**.
1. En la página Buscar en Forms , seleccione **[!UICONTROL Carril de búsqueda de administración de recursos]** y, a continuación, toque  **Editar** ![aemassets_edit](assets/aemassets_edit.png).
   ...
   >[!NOTE]
   >
   >Para utilizar la funcionalidad de búsqueda de carpetas desde la **Carril de búsqueda de administración de recursos** de un [!DNL Experience Manager] , realice estos pasos:
   > 
...
1. Toque o haga clic en el botón **[!UICONTROL Vista previa]** ![vista previa](assets/preview.png) para generar una vista previa del panel Filtros tal como aparece después de agregar el predicado.
...
1. Para cerrar la vista previa, toque o haga clic en el botón **[!UICONTROL Cerrar]** ![close](assets/close.png) en la esquina superior derecha de la vista previa.
...
1. Toque . [!DNL Experience Manager] y, a continuación, vaya a **[!UICONTROL Herramientas > General > Buscar Forms]**.
...
El predicado Propiedad de varios valores permite buscar recursos en busca de varios valores. Imagine un escenario en el que tiene imágenes de varios productos en [!DNL Experience Manager] Los recursos y los metadatos de cada imagen incluyen un número de SKU asociado al producto. Puede utilizar este predicado para buscar imágenes de producto basadas en varios números de SKU.
...
1. Toque **[!UICONTROL Eliminar]** ![deleteoutline](assets/deleteoutline.png) en la barra de herramientas.
