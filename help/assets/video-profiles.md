...
1. Defina la resolución del tamaño del fotograma de vídeo en píxeles. Utilice el valor **[!UICONTROL Automático]** para escalar automáticamente para que coincida con la proporción de aspecto del origen (relación de anchura y altura). Por ejemplo, Automático x 480 o 640 x Automático.
   ...
   * Para ayudarle a visualizar el tamaño del vídeo, toque el icono **[!UICONTROL Información]** (i) a la derecha de **[!UICONTROL Altura]** para abrir la página Calculadora **[!UICONTROL de]** tamaño. Utilice la calculadora **[!UICONTROL de tamaño]** para establecer las dimensiones de vídeo (representadas por el cuadro azul) que desee. Toque **[!UICONTROL X]** en la esquina superior derecha cuando haya terminado.
...
## Supervisión del progreso de un trabajo de codificación {#monitoring-the-progress-of-an-encoding-job}
...
1. (Opcional) Bajo el encabezado Tamaño **** de vídeo, desactive **[!UICONTROL Mantener relación]** de aspecto.
1. En el campo **[!UICONTROL Anchura]** , escriba **[!UICONTROL Automático]**; a la derecha del campo **[!UICONTROL Altura]** , toque el icono **[!UICONTROL Información]** . Use the **[!UICONTROL Size Calculator]** page to further set the video dimension (blue box) how you want. Toque **[!UICONTROL X]** cuando haya terminado.
...
1. Desde la página **[!UICONTROL CRXDE Lite]** , en el panel **[!UICONTROL Explorador]** de la izquierda, vaya a lo siguiente:
...
1. En el encabezado Ajustes preestablecidos **[!UICONTROL de codificación de]** vídeo, agregue, edite o elimine los ajustes preestablecidos de codificación de vídeo que componen el perfil.
...
1. En el encabezado Ajustes preestablecidos **[!UICONTROL de codificación de]** vídeo, agregue, edite o elimine los ajustes preestablecidos de codificación de vídeo que componen el perfil.
   ...
   Toque el icono **[!UICONTROL Información]** que hay junto a cada opción en las fichas **[!UICONTROL Básico]** y **[!UICONTROL Avanzado]** para ver las descripciones y la configuración recomendadas.
...
1. Select the **[!UICONTROL Video Profiles]** tab and select the profile from the drop-down menu and tap **[!UICONTROL Save &amp; Close]**. Las carpetas que ya tienen un perfil asignado se indican mediante la visualización del nombre del perfil directamente debajo del nombre de la carpeta.
...
1. En la carpeta, toque la marca de verificación para seleccionarla y, a continuación, **[!UICONTROL Propiedades]**.
1. Select the **[!UICONTROL Video Profiles]** tab and select **[!UICONTROL None]** from the drop-down menu and tap **[!UICONTROL Save &amp; Close]**. Las carpetas que ya tienen un perfil asignado se indican mediante la visualización del nombre del perfil directamente debajo del nombre de la carpeta.
