...
* [Extremos de calendario](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/calendar/client/endpoints/package-summary.html)

* [Personalizaciones del lado del servidor](server-customize.md)

### Función Calendario {#calendar-function}

Una estructura de sitio de comunidad que incluya la función [Calendario](functions.md#calendar-function) tendrá un componente c `alendar`configurado. La función Calendario permite identificar un [grupo de usuarios miembros privilegiados](users.md#privileged-members-group).
