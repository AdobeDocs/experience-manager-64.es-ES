...
La instancia de configuración de `AEM Communities Email Reply Configuration` OSGi con el correo electrónico Nombre es para la función de notificaciones. Esta función no incluye la respuesta por correo electrónico.
