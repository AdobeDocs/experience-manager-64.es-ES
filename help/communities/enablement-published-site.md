...
Lo que hay es la actividad de los dos alumnos, `Riley Taylor` y `Sidney Croft. By s`al seleccionar el vínculo `Administration`para acceder a la Consola de moderación, Quinn puede utilizar la [consola de moderación masiva](moderation.md) para moderar sus publicaciones.
...
Vaya a la **consola Informes [Comunidades](reports.md)** y genere informes de acuerdo con
