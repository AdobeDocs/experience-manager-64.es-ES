...
* **mode**: Cadena
   ...
   (opcional) Una lista de [Modos WCM](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) para probar si está configurado.
