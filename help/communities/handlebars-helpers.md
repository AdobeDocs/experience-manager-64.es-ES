...
* **modo**: Cadena
   ...
   (opcional) Una lista separada por comas de los modos [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) WCM que se van a probar si están configurados.
