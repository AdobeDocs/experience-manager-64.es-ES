...
* Instalar [MySQL Server](https://dev.mysql.com/downloads/mysql/) Community Server versión 5.6
...
* Instalar [Área de trabajo de MySQL](https://dev.mysql.com/downloads/tools/workbench/)
* En todas las instancias AEM, instale el [paquete SCORM](enablement.md#scorm)
...
* El `Connection Name` elegido se introduce como el nombre `datasource` en la [configuración OSGi JDBC](#configure-jdbc-connections)
...
* Introduzca los valores siguientes:
   ...
   * **URL** de conexión DBC:  `jdbc:mysql://localhost:3306/aem63reporting` especifique el servidor en lugar de localhost si el servidor MySQL no es el mismo que el servidor AEM &#39;this&#39;
