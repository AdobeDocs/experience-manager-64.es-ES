...
* En todas las AEM instancias, instale el [paquete SCORM](enablement.md#scorm)
...
* El `Connection Name` elegido se introduce como nombre `datasource` en la [configuración OSGi de JDBC](#configure-jdbc-connections)
