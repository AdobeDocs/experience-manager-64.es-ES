...
* para un recurso de habilitación: `Download Resource Report as CSV` button
* para una ruta de aprendizaje: `Download Learning Path Report as CSV` button
