...
* **[!UICONTROL Tamaño]** máximo del archivo relevante solo si está activada la opción **[!UICONTROL Permitir cargas]** de archivos. Este campo limita el tamaño (en bytes) de un archivo cargado. El valor predeterminado es 10 MB.
