...
* Para modificar la información disponible en la plantilla JS o en el extremo de GET
   * Ampliar el [componente social](server-customize.md#socialcomponent-interface)
* Adición de un procesamiento personalizado durante las operaciones
   * Escriba un [OperationExtension](server-customize.md#operationextension-class)
* Para agregar una nueva operación personalizada
   * Crear una nueva [Operación posterior de Sling](server-customize.md#postoperation-class)
...
* [Descripción general del proveedor de recursos de almacenamiento](srp.md) : Introducción y uso del repositorio
* [SRP y UGC Essentials](srp-and-ugc.md) : métodos y ejemplos de utilidad de la API SRP
