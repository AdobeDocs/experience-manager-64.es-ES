...
SocialComponentFactory (fábrica) registra un SocialComponent con el marco. La fábrica proporciona un medio para informar a la estructura de qué componentes sociales están disponibles para un resourceType determinado y su clasificación y difusión de prioridad; cuando se identifican varios componentes sociales.
...
Los códigos de estado HTTP utilizados correctamente son
