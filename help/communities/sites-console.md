...
* Habilitar el servicio [de](deploy-communities.md#tunnel-service-on-author) túnel para administrar miembros y grupos de miembros
* Identifique al publicador [principal](deploy-communities.md#primary-publisher)
* [Configurar la replicación](deploy-communities.md#replication-agents-on-author) cuando el puerto del publicador principal no es el predeterminado (4503)
...
Por ejemplo, la siguiente imagen muestra la consola principal Sitios de comunidades, que muestra las carpetas de dos sitios de comunidad: [habilitar](getting-started-enablement.md) y [participar](getting-started.md):
...
* **[!UICONTROL Menú Plantilla]** de sitio de comunidad: Utilice el menú desplegable para elegir una plantilla [de sitio de](tools.md)comunidad disponible.
...
Las [funciones de los miembros](users.md) de la comunidad se asignan con esta configuración.
...
* **[!UICONTROL Contenido con moderación previa]**
   ...
   Si se selecciona, el contenido de la comunidad publicado no aparecerá hasta que lo apruebe un moderador. El valor predeterminado no está marcado. Para obtener más información, consulte [Moderación del contenido](moderate-ugc.md#premoderation)de la comunidad.
...
* **[!UICONTROL Referencia de la estructura de configuración de la nube]**
   ...
   `Communities`es el ejemplo de marco de la documentación de funciones [de Configuración de](analytics.md#aem-analytics-framework-configuration) Analytics para comunidades.
...
* **[!UICONTROL Activar la traducción automática para los idiomas seleccionados]**
   ...
   Los idiomas habilitados para la traducción automática se establecen de forma predeterminada en la configuración del sistema especificada por la configuración [de la integración de](translate-ugc.md#translation-integration-configuration)traducción. Esta configuración predeterminada se puede anular para este sitio eliminando los valores predeterminados o seleccionando otros idiomas en el menú desplegable.
...
* **[!UICONTROL Procesamiento]** inteligente Seleccione uno de los
...
La `ENABLEMENT`configuración se aplica cuando la plantilla de sitio de comunidad elegida incluye la función [](functions.md#assignments-function)asignaciones, que está disponible cuando las funciones de habilitación tienen licencia y están [configuradas](enablement.md). La plantilla de sitio de referencia que incluye la función de asignaciones es `Reference Structured Learning Site Template.`

* **[!UICONTROL Administradores de habilitación]**

   (obligatorio) Solo los miembros del `Community Enablementmanagers` grupo están disponibles para ser seleccionados para administrar esta comunidad de habilitación. Los administradores de habilitación son responsables de asignar miembros a los recursos. Consulte también [Administración de usuarios y grupos](users.md)de usuarios.
...
Después de publicar un sitio de comunidad, es necesario publicar individualmente cada subcomunidad (grupo anidado) creada mediante la consola [](groups.md)Grupos.
...
* Introduzca las asignaciones **[!UICONTROL de página de inicio de sesión]** de la siguiente manera:
