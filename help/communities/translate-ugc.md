...
* **[!UICONTROL Configuración]**
 principal (obligatoria) Normalmente se deja como predeterminado. El valor predeterminado es 
`/etc/cloudservices/translation`.

* **[!UICONTROL Título]**
 (obligatorio) Introduzca un título para mostrar de su elección. No hay ningún valor predeterminado.
...
* **[!UICONTROL Acrónimo]** de sitio: puede salir como predeterminado
* **** Acrtud:
   * **[!UICONTROL Proveedor]**
...
* **** Assetstab: puede salir como predeterminado
