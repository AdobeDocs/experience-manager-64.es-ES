...
* Tener [contactos del recurso de habilitación](resources.md)
* Tenga [privilegios](#privileged-members-group) para crear entradas para blogs, calendarios, QnA y foros

Los usuarios registrados en el entorno de publicación generalmente se conocen como *miembros de la comunidad (miembros)* para distinguirlos de *usuarios *en el entorno del autor.
...
En el entorno de publicación, en función de la [configuración](sites-console.md#user-management) del sitio de la comunidad, un visitante del sitio puede convertirse en miembro de la comunidad
...
1. Configurar LDAP para cada instancia de publicación AEM
...
* **[Grupos comunitarios](overview.md#communitygroups)**
