...
+ Instalación y configuración de AEM Forms {#install-aem-forms}
   ...
   + Instalación de AEM Forms en OSGi {#osgi-installation}
      ...
      + [Instalar y configurar servicios de documentos](using/install-configure-document-services.md)
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [Instalación y configuración únicamente del servidor de seguridad de documentos](using/installing-and-configuring-the-document-security-server.md)
...
+ Actualización de AEM Forms {#upgrade-aem-forms}
   ...
   + Actualizar AEM Forms en JEE {#aem-forms-jee-upgrade}
      ...
      + [Actualización de una versión de AEM Forms a AEM 6.4 Forms en JEE para JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      ...
      + [Actualización de LiveCycle ES4 SP1 a AEM Forms en JEE para WebSphere](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
+ Administrar formularios AEM {#manage-administer-aem-forms}
   ...
   + Endurecimiento del entorno de AEM Forms {#hardening-aem-forms-environment}
      + [Endurecimiento y seguridad de los formularios AEM en un entorno OSGi](using/hardening-securing-aem-forms-environment.md)
...
+ Formularios adaptables: creación avanzada {#adaptive-forms-advanced-authoring}
   ...
   + [Uso del flujo de trabajo de traducción de AEM para localizar formularios adaptables y documentos de registro](using/using-aem-translation-workflow-to-localize-adaptive-forms.md)
...
+ Flujos de trabajo {#workflows}
   ...
   + [Acciones y capacidades de flujos de trabajo de AEM centrados en formularios en los flujos de trabajo de OSGi y AEM Forms JEE](using/capabilities-osgi-jee-workflows.md)
   + [Inicio de las API de Document Services desde el flujo de trabajo de AEM](using/initiating-document-services-apis-aem.md)
+ Espacio de trabajo de AEM Forms {#use-aem-forms-workspace}
   ...
   + [Obtención de variables de tarea en la dirección URL de resumen](using/getting-task-variables-summary-url.md)
...
+ AEM Forms app {#aem-forms-app}
   ...
   + [Adición de datos adjuntos](using/add-attachments.md)
...
+ HTML5 Forms {#html5-forms}
   ...
   + [Generar vista previa HTML5 de un formulario XDP](using/preview-xdp-forms-html.md)
...
+ Cartas y correspondencias {#letters-correspondences}
   ...
   + [Agregar una acción personalizada a la vista Lista de recursos](using/add-custom-action-asset-listing-view.md)
   + [Agregar acción/botón personalizado en la interfaz de usuario Crear correspondencia](using/add-action-button-in-create-correspondence-ui.md)
   ...
   + [Marca de agua personalizada en vista previa de PDF de carta](using/custom-watermark.md)
...
+ Integración de AEM Forms con las soluciones de Experience Cloud {#integrate-aem-forms-with-experience-cloud-solutions}
   ...
   + [Visualización y comprensión de los informes de análisis de AEM Forms](using/view-understand-aem-forms-analytics-reports.md)
...
+ Publicación y procesamiento de formularios AEM {#publish-process-aem-forms}
   ...
   + [Gestión de aplicaciones y tareas de formularios en la bandeja de entrada de AEM](using/manage-applications-inbox.md)
...
+ Servicios de documentos {#use-document-services}
   ...
   + [Utilice HSM para firmar o certificar documentos digitalmente](using/hsm-certify-esign-docs.md)
...
+ :Seguridad de los documentos{#use-document-security}
   ...
   + [Permitir que AEM busque documentos PDF protegidos por seguridad de documentos](using/enable-search-for-drm-protected-pdf-documents-in-aem.md)
   + [Reader amplía los documentos PDF protegidos por políticas mediante la biblioteca de protección portátil](using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
   + [Permitir que AEM busque documentos PDF protegidos de seguridad de documentos y documentos de Microsoft Office](using/enable-search-for-drm-protected-pdf-and-office-documents-in-aem.md)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [Conceptos básicos de secuencias de comandos de Designer](http://www.adobe.com/go/learn_aemforms_scriptingBasics_64)
...
+ Personalización de AEM Forms {#customize-aem-forms}
   ...
   + [Adición de acciones personalizadas a elementos de la lista de formularios](using/add-custom-action-form-lister.md)
   ...
   + [Personalización del seguimiento de sucesos de formulario](using/customizing-form-event-tracking.md)
...
+ Ayuda del administrador para AEM Forms en JEE {#administrator-help}
   ...
   + Trabajar con la seguridad del documento {#work-with-document-security}
      + [Acerca de la seguridad del documento](/help/forms/using/admin-help/document-security.md)
      ...
      + [Monitoreo de eventos](/help/forms/using/admin-help/monitoring-events.md)
   ...
   + Monitor de estado {#health-monitor}
      ...
      + [Ver estadísticas relacionadas con el Administrador de trabajo](/help/forms/using/admin-help/view-statistics-related-manager.md)
   ...
   + Backup y recuperación de formularios AEM {#aem-forms-backup-recovery}
      ...
      + [Estrategia para backup y restore en un entorno en clúster](/help/forms/using/admin-help/strategy-backup-restore-clustered-environment.md)
...
+ Informes de procesos {#process-reporting}
   + [Introducción a los informes de procesos](/help/forms/using/process-reporting/introduction-process-reporting.md)
   + [Introducción a los informes de procesos](/help/forms/using/process-reporting/install-start-process-reporting.md)
   ...
   + [Informes personalizados en proceso Informes](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
...
+ Referencia del programador {#developer-reference}
   ...
   + Programación con AEM Forms en JEE {#programming-aem-forms-jee}
      ...
      + Inicio rápido de la API de Java: ejemplos de código {#java-api-quick-start-code-examples}
         + [Inicio rápido de JavaAPI del cliente de Application Manager (SOAP)](developing/application-manager-client-java-api.md)
         + [Inicio rápido de Application Manager Service JavaAPI (SOAP)](developing/application-manager-service-java-api.md)
         ...
         + [APIQuick Starts del servicio de copia de seguridad y restauración](developing/backup-restore-service-api-quick.md)
         + [API de Java del servicio de formularios con códigos de barrasInicio rápido (SOAP)](developing/barcoded-forms-service-java-api.md)
         + [Java APIQuick Start (SOAP) de Componentes y Servicios](developing/components-services-java-api-quick.md)
         ...
         + [Document Management Service (obsoleto)Inicio rápido de la API de Java (SOAP)](developing/document-management-service-deprecated-java.md)
         + [Inicio rápido de la API de JavaAPI de Document Security Service (SOAP)](developing/document-security-service-java-api.md)
         ...
         + [Inicio rápido de la API del servicio de formularios](developing/forms-service-api-quick-starts.md)
         ...
         + [Inicio rápido de LiveCycleProcess Java API(SOAP)Quick](developing/livecycleprocess-java-api-soap-quick.md)
         + [Inicio rápido de la API de Java del servicio de salida (SOAP)](developing/output-service-java-api-quick.md)
         + [API de Java del servicio de utilidades de PDFinicio rápido (SOAP)](developing/pdf-utilities-service-java-api.md)
         + [Inicio rápido de API de servicio de repositorio](developing/repository-service-api-quick-starts.md)
         ...
         + [API de Java del servicio de utilidades XMP Inicio rápido (SOAP)](developing/xmp-utilities-service-java-api.md)
      ...
      + Realización de operaciones de servicio mediante API {#performing-service-operations-using-apis}
         ...
         + [Compilación de documentos PDF mediante programación](developing/programmatically-assembling-pdf-documents.md)
         ...
         + [Representación de formularios basados en fragmentos](developing/rendering-forms-based-fragments.md)
