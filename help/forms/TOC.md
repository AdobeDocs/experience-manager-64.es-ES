...
+ Notas de la versión {#release-notes-new-features}
   ...
   + [Funciones en desuso](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/deprecated-removed-features.html?lang=es)
+ Introducción {#getting-started}
   ...
   + Tutorial: Crear la primera comunicación interactiva {#create-first-interactive-communication}
      ...
      + [Tutorial: Crear un modelo de datos de formulario](using/create-form-data-model-tutorial.md)
      ...
      + [Tutorial: Crear comunicaciones interactivas](using/create-interactive-communication-tutorial.md)
   + Colaterales de referencia de AEM Forms {#aem-forms-reference-collaterals}
      ...
      + [Tutorial del sitio de referencia de We.Gov para el cumplimiento de la ley ](using/gov-reference-site-walkthrough.md)
...
+ Instalar y configurar AEM Forms {#install-aem-forms}
   ...
   + Instalar AEM Forms en OSGi {#osgi-installation}
      + [Plataformas compatibles con AEM Forms en OSGi](https://helpx.adobe.com/es/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
   ...
   + Instalar AEM Forms en JEE {#jee-installation}
      ...
      + [Instalar e implementar AEM Forms en JEE mediante JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_installTurnkey_64)
      ...
      + [Instalar e implementar Adobe Experience Manager Forms en JEE para JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      + [Instalar e implementar AEM Forms en JEE para WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      ...
      + [Instalar Workbench de AEM Forms](http://help.adobe.com/en_US/AEMForms/6.1/InstallWorkbench/index.html)
      + [Instalar y configurar Designer](using/installing-configuring-designer.md)
      + [Preparar la instalación de AEM Forms (clúster de servidor)](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      + [Configurar Adobe Experience Manager Forms en JEE en el clúster de JBoss ](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [Configurar Adobe Experience Manager Forms en JEE en el clúster de WebLogic ](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [Configurar Adobe Experience Manager Forms en JEE en el clúster de WebSphere ](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
   + Configurar AEM Forms {#configure-aem-forms}
      ...
      + [Configurar el conector para Microsoft SharePoint](http://help.adobe.com/en_US/AEMForms/6.1/SharePointConfig/index.html)
...
+ Actualizar AEM Forms {#upgrade-aem-forms}
   ...
   + Actualizar AEM Forms en OSGi {#aem-forms-osgi-upgrade}
      + [Actualizar a formularios AEM 6.4 en OSGi](using/upgrade-forms-osgi.md)
   ...
   + Actualizar AEM Forms en JEE {#aem-forms-jee-upgrade}
      + [Preparar para actualizar AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareupgrade_64)
      ...
      + [Actualizar a Adobe Experience Manager Forms en JEE para JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      ...
      + [Actualizar a AEM Forms en JEE para JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      ...
      + [Actualizar a Adobe Experience Manager Forms en JEE para WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      ...
      + [Actualizar a Adobe Experience Manager Forms en JEE para WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
...
+ Referencia del desarrollador {#developer-reference}
   ...
   + [Referencia de la API de AEM Forms Java](https://helpx.adobe.com/es/experience-manager/6-4/forms/javadocs/index.html)
   ...
   + [Referencia de la API de la biblioteca JavaScript para formularios adaptables](https://helpx.adobe.com/es/experience-manager/6-4/forms/javascript-api/index.html)
   + [Servicio Assembler y referencia DDX](http://www.adobe.com/go/learn_aemforms_ddxRef_64)
   + [Ayuda de Workbench](http://www.adobe.com/go/learn_aemforms_workbench_64_es)
