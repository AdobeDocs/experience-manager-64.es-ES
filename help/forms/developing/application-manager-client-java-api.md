---
title: Inicio rápido JavaAPI del cliente de Application Manager (SOAP)
seo-title: Inicio rápido JavaAPI del cliente de Application Manager (SOAP)
description: Utilice el cliente de Application Manager para crear una versión de aplicación, exportar aplicaciones, importar aplicaciones, obtener una aplicación de AEM Forms, obtener aplicaciones, obtener el estado de las aplicaciones, previsualización de AEM Forms y del archivo de aplicaciones posteriores, y eliminar el archivo de aplicaciones de AEM Forms.
seo-description: Utilice el cliente de Application Manager para crear una versión de aplicación, exportar aplicaciones, importar aplicaciones, obtener una aplicación de AEM Forms, obtener aplicaciones, obtener el estado de las aplicaciones, previsualización de AEM Forms y del archivo de aplicaciones posteriores, y eliminar el archivo de aplicaciones de AEM Forms.
...
# Inicio rápido JavaAPI (SOAP) del cliente de Application Manager {#application-manager-client-javaapi-quick-start-soap}
...
[Inicio rápido (modo SOAP): Obtención de una aplicación de AEM Forms mediante la API de Java](application-manager-client-java-api.md#quick-start-soap-mode-getting-a-application-using-the-java-api)

[Inicio rápido (modo SOAP): Obtención de las aplicaciones mediante la API de Java](application-manager-client-java-api.md#quick-start-soap-mode-getting-the-applications-using-the-java-api)
...
El siguiente ejemplo de código Java crea una aplicación mediante la API de JAVA.
...
>[!NOTE]
>
>La API de Java importApplication() reemplaza las aplicaciones existentes con el mismo nombre por una aplicación más reciente. Para actualizar una aplicación existente, utilice la API importApplication() en lugar de la API updateApplication().
...
## Inicio rápido (modo SOAP): Obtención de una aplicación mediante la API de Java {#quick-start-soap-mode-getting-a-application-using-the-java-api}
...
## Inicio rápido (modo SOAP):Eliminación del archivo de aplicaciones mediante la API de Java {#quick-start-soap-mode-deleting-the-application-archive-using-the-java-api}

El siguiente ejemplo de código Java es para eliminar un archivo de aplicaciones.
