...
Este documento DDX combina dos documentos PDF denominados *map.pdf* y* direccionamiento.pdf* en un único documento PDF. El documento PDF resultante contiene un encabezado que consta de un identificador de página único. Por ejemplo, el documento de la ilustración anterior muestra 000016.
