...
Este documento DDX combina dos documentos PDF llamados *map.pdf* y* direccionamientos.pdf* en un solo documento PDF. El documento de PDF resultante contiene un encabezado que consta de un identificador de página único. Por ejemplo, el documento de la ilustración anterior muestra 000016.
