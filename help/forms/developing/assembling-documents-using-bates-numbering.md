...
Este documento DDX combina dos documentos PDF con el nombre *map.pdf* e* direcciónes.pdf* en un único documento PDF. El documento PDF resultante contiene un encabezado que consta de un identificador de página único. Por ejemplo, el documento de la ilustración anterior muestra 000016.
