...
>[!NOTE]
>
>En este contexto, el término adicional significa el contenido del appmon.[application.name].add.[locale]archivo .xml. Este archivo especifica anulaciones y adiciones al archivo XML de diálogo.
...
El nombre del archivo XML del cuadro de diálogo adicional debe utilizar el formato appmon.*[application.name]*.add.*[locale]*.xml, donde *application.name* debe coincidir exactamente con el nombre de la aplicación utilizado en el archivo de configuración XML y en la secuencia de comandos.
...
1. En el cuadro de diálogo Nueva variable del sistema, en la **Nombre de variable** , escriba un nombre que utilice el formato *[application.name]*_PATH.
