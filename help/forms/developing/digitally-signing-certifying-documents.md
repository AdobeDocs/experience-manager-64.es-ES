...
[Verificación de firmas digitales mediante la API de servicio web](#unresolvedlink-lc-si)
...
Iterar a través de cada firma. Es decir, para cada firma, verifique la firma digital y compruebe la identidad del firmante y el estado de cada firma. (Consulte [Verificación de firmas digitales](#unresolvedlink-lc-si)).
