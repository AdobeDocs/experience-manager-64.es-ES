...
* Valide las firmas digitales ubicadas en un documento PDF. (Consulte [Verificación de firmas digitales](#unresolvedlink-lc-si).)
* Valide todas las firmas digitales ubicadas en un documento PDF. (Consulte [Verificación de varias firmas digitales](#unresolvedlink-lc-si)).
...
Repita cada firma. Es decir, para cada firma, verifique la firma digital y la identidad del firmante y el estado de cada firma. (Consulte [Verificación de firmas digitales](#unresolvedlink-lc-si).)
