...
El siguiente ejemplo de código Java crea un nuevo espacio denominado *Test Directory *ubicado en el hogar de la empresa. El valor de identificación del nuevo espacio se escribe en la consola.
