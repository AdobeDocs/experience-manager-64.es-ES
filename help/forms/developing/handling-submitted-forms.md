...
>[!NOTE]
>
>Los cálculos y las validaciones se deben devolver al usuario. (Consulte [Cálculo de datos](/help/forms/developing/calculating-form-data.md#calculating-form-data)de formulario.)
