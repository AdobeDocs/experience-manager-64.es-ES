---
title: API de Java del servicio de utilidades de PDFinicio rápido (SOAP)
seo-title: API de Java del servicio de utilidades de PDFinicio rápido (SOAP)
description: nulo
...
Los siguientes inicios rápidos están disponibles para el servicio de utilidades de PDF.

[Inicio rápido (modo SOAP): Conversión de un documento PDF a un documento XDP mediante la API de Java](pdf-utilities-service-java-api.md#quick-start-soap-mode-converting-a-pdf-document-to-an-xdp-document-using-the-java-api)

[Inicio rápido (modo SOAP): Conversión de un documento XDP a un documento PDF mediante la API de Java](pdf-utilities-service-java-api.md#quick-start-soap-mode-converting-an-xdp-document-to-a-pdf-document-using-the-java-api)
...
[Inicio rápido (modo SOAP):Anidación de documentos PDF](pdf-utilities-service-java-api.md#quick-start-soap-mode-sanitizing-pdf-documents)
...
## Inicio rápido (modo SOAP): Conversión de un documento PDF a un documento XDP mediante la API de Java {#quick-start-soap-mode-converting-a-pdf-document-to-an-xdp-document-using-the-java-api}

El siguiente ejemplo de código convierte un documento PDF en un documento XDP. (Consulte [Conversión de documentos PDF en documentos](/help/forms/developing/pdf-utilities.md#converting-pdf-documents-into-xdp-documents)XDP.
...
## Inicio rápido (modo SOAP): Conversión de un documento XDP a un documento PDF mediante la API de Java {#quick-start-soap-mode-converting-an-xdp-document-to-a-pdf-document-using-the-java-api}

El siguiente ejemplo de código convierte un documento XDP en un documento PDF. (Consulte [Conversión de documentos XDP en documentos](/help/forms/developing/pdf-utilities.md#converting-xdp-documents-into-pdf-documents)PDF).
...
El siguiente ejemplo de código determina si el documento es un documento PDF y, si es así, la versión más antigua de Acrobat que puede leerlo. (Consulte [Recuperación de propiedades](/help/forms/developing/pdf-utilities.md#retrieving-pdf-document-properties)del documento PDF).
...
## Inicio rápido (modo SOAP): Configuración del estilo de guardado de un documento PDF mediante la API de Java {#quick-start-soap-mode-setting-the-save-style-for-a-pdf-document-using-the-java-api}

En el siguiente ejemplo de código se establece el modo de guardado para una visualización rápida de Web y, a continuación, se pasa el documento PDF al servicio de cifrado donde está cifrado. El documento PDF cifrado que se guarda para una visualización rápida de la Web se guarda como un archivo PDF denominado* FastWebViewLoan.pdf*. (Consulte [Configuración de los modos](/help/forms/developing/pdf-utilities.md#setting-pdf-document-save-modes)de guardado de documentos PDF).
...
## Inicio rápido (modo SOAP): Conversión de un documento a un documento PDF/A-2b mediante la API de Java {#quick-start-soap-mode-converting-a-document-to-a-pdf-a-2b-document-using-the-java-api}

El siguiente ejemplo de código Java convierte un documento PDF llamado *Loan.pdf* en un documento PDF/A-2b que se guarda como archivo PDF llamado *LoanArchive.pdf*. (Consulte [Conversión de documentos a documentos](/help/forms/developing/pdf-a-documents.md#converting-documents-to-pdf-a-documents)PDF/A).
...
## Inicio rápido (modo SOAP): Anidación de documentos PDF {#quick-start-soap-mode-sanitizing-pdf-documents}
