...
* documentos protegidos por políticas de Inspect. Para obtener más información, consulte [Inspección de Documentos](protecting-documents-policies.md#inspecting-policy-protected-pdf-documents)PDF protegidos por políticas.
...
>[!NOTE]
>
>Para obtener información sobre otros atributos que puede definir, consulte la descripción de la `Policy` interfaz en la Referencia [de API de](https://www.adobe.com/go/learn_aemforms_javadocs_63_en)AEM Forms.
...
1. Cree un objeto API de cliente de seguridad de Documento.
   ...
   * Habilite la autenticación HTTP básica realizando las siguientes tareas:
      ...
      * Asigne el nombre de usuario de AEM formularios al campo `RightsManagementServiceClient.ClientCredentials.UserName.UserName`.
...
1. Cree un objeto API de cliente de seguridad de Documento.
   ...
   * Habilite la autenticación HTTP básica realizando las siguientes tareas:
      ...
      * Asigne el nombre de usuario de AEM formularios al campo `DocumentSecurityServiceClient.ClientCredentials.UserName.UserName`.
...
>[!NOTE]
>
>Para obtener más información sobre el servicio Rights Management, consulte [Servicios de referencia para AEM Forms](https://www.adobe.com/go/learn_aemforms_services_63).
...
Antes de realizar una operación de servicio Rights Management mediante programación, debe crear un objeto cliente de servicio Rights Management. Si utiliza la API de Java, cree un `DocumentSecurityClient` objeto. Si está utilizando la API de servicio web de Rights Management, cree un `DocumentSecurityServiceService` objeto.
