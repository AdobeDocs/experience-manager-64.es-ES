...
1. En la página Crear audiencia , cree reglas. Las reglas permiten clasificar la audiencia. Por ejemplo, desea categorizar las audiencias en función del sistema operativo. La audiencia A proviene de Windows y la audiencia B procede de Linux.
   ...
   * Para categorizar la audiencia según Windows, en la Regla 1, seleccione **Sistema operativo** tipo de atributo. En la lista desplegable Cuándo , seleccione **Windows**.
   * Para categorizar la audiencia según Linux, en la Regla #2, seleccione **Sistema operativo** tipo de atributo. En la lista desplegable Cuándo , seleccione **Linux** y haga clic en **Siguiente**.
