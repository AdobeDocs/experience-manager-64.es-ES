...
Para hacer que un componente sea obligatorio, en el diálogo **[!UICONTROL Editar]** del componente, puede seleccionar la opción **[!UICONTROL Título y texto > Requerido]**. También puede agregar el **mensaje obligatorio** (opcional). .
