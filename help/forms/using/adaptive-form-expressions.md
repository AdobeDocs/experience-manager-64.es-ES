...
* **[Expresión de clics](/help/forms/using/adaptive-form-expressions.md#p-click-expression-p)**: para controlar las acciones al hacer clic en un botón.
* **[Script de inicialización](/help/forms/using/adaptive-form-expressions.md#p-initialization-script-p):** realiza una acción sobre la inicialización de un campo.

* **[Expresión de opciones](/help/forms/using/adaptive-form-expressions.md#p-options-expression-p)**: para rellenar dinámicamente una lista desplegable.
...
* **[Script de implementación de valor](/help/forms/using/adaptive-form-expressions.md#p-value-commit-script-p):** para cambiar los componentes de un formulario después de cambiar el valor de un campo.

* **[Expresión de visibilidad](/help/forms/using/adaptive-form-expressions.md#p-visibility-expression-p)**: para controlar la visibilidad de un campo y de un panel.
* **[Expresión de finalización de un paso](/help/forms/using/adaptive-form-expressions.md#p-step-completion-expression-p)**: para evitar que un usuario vaya al siguiente paso de un asistente.
...
Siempre que el valor de **marital_status** cambia, se recupera la expresión. También puede rellenar el menú desplegable desde un servicio REST. Para obtener información detallada, consulte [Rellenado dinámico de desplegables](/help/forms/using/dynamically-populate-dropdowns.md).
