...
* El formulario adaptable habilitado para Acrobat Sign solo se envía después de que todos los firmantes hayan firmado el formulario. Forms aparecerá en estado de firma pendiente hasta que todos los firmantes firmen el formulario.
...
* Crear [páginas de error personalizadas mostradas por el administrador de errores](https://helpx.adobe.com/experience-manager/6-2/sites-developing/customizing-errorhandler-pages.html).
