...
### Añada el proceso de LiveCycle para habilitar el manejo de la acción <span class="acrolinxCursorMarker"></span> {#add-the-livecycle-process-to-enable-action-span-class-acrolinxcursormarker-span-handling}
