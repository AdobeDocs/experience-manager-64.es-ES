...
### Añadir el proceso de LiveCycle para habilitar la <span class="acrolinxCursorMarker"></span>gestión de acciones {#add-the-livecycle-process-to-enable-action-span-class-acrolinxcursormarker-span-handling}
