...
Evite crear nombres de usuario que comiencen con un signo de número (#). Al realizar búsquedas de tarea no se obtienen resultados para esos nombres de usuario. (See [Working with tasks](/help/forms/using/admin-help/tasks.md#working-with-tasks).)
...
1. Para buscar al usuario que editar, realice las siguientes tareas:
   ...
   * En la lista **** En, seleccione **[!UICONTROL Usuarios]**.
