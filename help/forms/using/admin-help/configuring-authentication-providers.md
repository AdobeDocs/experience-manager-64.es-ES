...
1. Haga clic en un dominio existente en la lista. Si va a agregar autenticación para un nuevo dominio, consulte [Añadir un dominio](/help/forms/using/admin-help/adding-domains.md#add-an-enterprise-domain) de empresa o [Añadir un dominio](/help/forms/using/admin-help/adding-domains.md#add-a-hybrid-domain)híbrido.
...
* Añada la siguiente propiedad personalizada para especificar la contraseña del usuario especificado en `saml.idp.resolve.username`.
...
1. Escriba un contenedor de servicio que implemente las interfaces IdentityCreator y AssignmentProvider. (Consulte [Programación con AEM formularios](https://www.adobe.com/go/learn_aemforms_programming_63)).
