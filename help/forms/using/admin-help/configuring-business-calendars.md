...
1. [Opcional] Seleccione Usar horas laborables y especifique el inicio y las horas de finalización de los días laborables.
...
1. En la lista El sistema usará, seleccione User Manager Business Calendar Key Resolution (Administrador de usuarios: resolución clave del calendario comercial).
