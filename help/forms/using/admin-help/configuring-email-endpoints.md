...
**Patrón de archivos:** los patrones de datos adjuntos de archivos entrantes que acepta el proveedor. Esto incluye archivos que tienen extensiones específicas (&amp;ast;.dat, &amp;ast;.xml), nombres específicos (datos) y expresiones compuestas en el nombre y la extensión (.[dD][aA][Tt]). El valor predeterminado es &amp;ast;.&amp;ast;..
...
**Patrón de archivos:** especifica los patrones de datos adjuntos de archivos entrantes que acepta el proveedor. Esto incluye archivos que tienen extensiones específicas (&amp;ast;.dat, &amp;ast;.xml), nombres específicos (datos) o expresiones compuestas en el nombre y la extensión (&amp;ast;..[dD][aA][Tt]).
