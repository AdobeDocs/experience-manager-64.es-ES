...
1. Defina la contraseña del nuevo usuario introduciendo `passwd` en el símbolo del sistema.
1. (Linux y Solaris) Para crear un archivo de contraseña de sombra, escriba `pwconv` (sin parámetros) en el símbolo del sistema.
...
1. Añada el usuario que creó en el paso 2 al grupo `root`.
1. Guarde y cierre el archivo.
1. (UNIX con SSL habilitado) Inicio y detenga WebSphere como el usuario raíz.
...
1. Anule la selección de **El usuario debe cambiar la contraseña en el próximo inicio de sesión**, haga clic en **Crear** y, a continuación, haga clic en **Cerrar**.
1. Haga clic en **Usuarios**, haga clic con el botón secundario en el usuario que acaba de crear y seleccione **Propiedades**.
1. Haga clic en la ficha **Miembro de** y, a continuación, haga clic en **Añadir**.
1. En el cuadro Escriba los nombres de los objetos para seleccionar, escriba `Administrators`, haga clic en Comprobar nombres para asegurarse de que el nombre del grupo es correcto.
1. Haga clic en **Aceptar** y luego haga clic en **Aceptar** nuevamente.
1. Seleccione **Inicio > Panel de control de Campaign > Herramientas administrativas > Política de seguridad local > Directivas locales**.
...
1. Haga clic en **Añadir usuario o grupo**.
1. En el cuadro Escriba los nombres de los objetos que se deben seleccionar, escriba el nombre del usuario que creó en el paso 4, haga clic en **Comprobar nombres** para asegurarse de que el nombre es correcto y, a continuación, haga clic en **Aceptar**.
1. Haga clic en **Aceptar** para cerrar el cuadro de diálogo Actuar como parte de las propiedades del sistema operativo.
...
1. Haga clic en Añadir y haga lo siguiente:

   1. Escriba **&amp;ast;** en el cuadro de búsqueda y haga clic en search.
   1. Haga clic en **Administrador** en Funciones.
   1. Añada el usuario recién creado a Asignado a la función y asígnelo al administrador.

1. Haga clic en **Aceptar** y guarde los cambios.
1. Reinicie el perfil WebSphere.
...
1. En la lista desplegable **Uso del almacén de claves**, asegúrese de que **almacenes de claves SSL** está seleccionado. Haga clic en **Nuevo**.
...
1. Seleccione **NodeDeafultSSLSsting**.
1. En las listas desplegables nombre del almacén de confianza y nombre del almacén de claves, seleccione el almacén de claves y el almacén de claves personalizados que ha creado.
1. Haga clic en **Aplicar**.
1. Guarde la configuración maestra.
1. Reinicie el perfil WebSphere.
...
1. En la Consola administrativa de WebSphere, seleccione **Seguridad > Seguridad global**.
1. En la sección Autenticación, expanda **seguridad de RMI/IIOP** y haga clic en **comunicaciones de entrada de CSIv2**.
1. Asegúrese de que **SSL-supported** esté seleccionado en la lista desplegable Transporte.
1. Reinicie el perfil WebSphere.
...
## Configure el archivo sling.properties {#configure-the-sling-properties-file}

1. Abra [aem-forms_root]\crx-repository\launchpad\sling.properties archivo para editarlo.
