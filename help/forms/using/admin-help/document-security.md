...
# Seguridad de documento {#about-document-security}
...
Una *política* define un conjunto de parámetros de confidencialidad y usuarios que pueden acceder a un documento al que se aplica la política. Una directiva también permite cambiar dinámicamente los permisos de un documento. Proporciona a la persona que asegura el permiso del documento para cambiar los parámetros de confidencialidad para anular el acceso al documento o cambiar la política.
