...
1. Recupere la base de datos de formularios AEM ejecutando primero una operación de restauración de la base de datos mediante los archivos de copia de seguridad de la base de datos y, a continuación, aplicando los redo logs de transacciones a la base de datos recuperada. (Consulte [AEM base de datos](/help/forms/using/admin-help/files-back-recover.md#aem-forms-database)de formularios). Para obtener más información, consulte uno de estos artículos de la base de conocimiento:
...
1. Inicio AEM formularios (consulte [Inicio y parada de servicios](/help/forms/using/admin-help/starting-stopping-services.md#starting-and-stopping-services))<!-- BROKEN LINK and the application server(s) (see [Maintaining the Application Server](/forms/using/admin-help/topics/maintaining-the-application-server.md))-->.
