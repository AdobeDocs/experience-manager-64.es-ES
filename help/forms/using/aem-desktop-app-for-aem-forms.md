...
Puede descargar la aplicación desde una instancia de AEM. Para obtener información detallada sobre la descarga de la aplicación, consulte [AEM notas](https://helpx.adobe.com/experience-manager/desktop-app/release-notes.html)de la versión de la aplicación de escritorio.
