...
La aplicación AEM Forms requiere un servidor AEM Forms. Los usuarios pueden procesar los formularios que cree en los AEM Forms\
...
Para obtener más información sobre la aplicación de AEM Forms que trabaja con el servidor de AEM Forms, consulte [Conard obtiene la tarea](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) de evaluación en la documentación de refsite.
