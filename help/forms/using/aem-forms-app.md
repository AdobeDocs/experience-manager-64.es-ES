...
Para obtener más información sobre la aplicación de AEM Forms que trabaja con el servidor de AEM Forms, consulte [Conard obtiene la tarea de evaluación](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) en la documentación de refsite.
...
1. Para descargar el paquete, abra `https://<server>:<port>/crx/de/content/forms/mobileapps/src/adobe-lc-mobileworkspace-src-<version>.zip` en el explorador.
