...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>Base de datos de Oracle 12c Release 1</p> </td> 
   <td><p>Repositorio Microkernel</p> </td> 
   <td><p>Compatible</p> </td> 
  </tr> 
  <tr> 
   <td><p>Servidor Microsoft SQL 2016</p> </td> 
   <td><p>Repositorio Microkernel</p> </td> 
   <td><p>Compatible</p> </td> 
  </tr> 
 </tbody> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>Servidor Oracle WebLogic 12.2.1 (12c R2) <sup>[1] [2] [4] [8]</sup></p> </td> 
   <td><p>A: Compatible</p> </td> 
...
* AEM Forms en JEE soporta varios software de terceros según nuestra [Directiva de soporte de software de terceros](#third-party-patch-support-policy).
...
* AEM Forms en JEE no es compatible con la base de datos MySQL en un entorno de clústeres.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><a href="https://helpx.adobe.com/es/acrobat/release-note/release-notes-acrobat-reader.html">Seguimiento clásico de Acrobat 2017</a></td> 
...
>Además:
>
>* El generador de PDF requiere una versión de 32 bits de [Acrobat 2017 Classic track versión 17.011.30078 o posterior](https://helpx.adobe.com/es/acrobat/release-note/release-notes-acrobat-reader.html) para realizar la conversión.
...
* [Requisitos del sistema para AEM Forms de un solo servidor en una implementación JEE](https://www.adobe.com/go/learn_aemforms_sysreq_single_64_es)
* [Requisitos del sistema para una implementación de AEM Forms en clúster en JEE](https://www.adobe.com/go/learn_aemforms_sysreq_cluster_64_es)
...
>[!NOTE]
>
>Si todas estas ubicaciones residen en una sola unidad, debe haber 1,5 GB de espacio disponible durante la instalación. Los archivos copiados en los directorios temporales se eliminan cuando finaliza la instalación.
...
>[!NOTE]
>
>La familia de productos de Acrobat DC presenta dos pistas tanto para Acrobat como para Reader, que son esencialmente productos diferentes: &quot;Classic&quot; y &quot;Continuous&quot;. Para obtener detalles y una comparación de ambas, consulte [https://www.adobe.com/go/acrobatdctracks](https://www.adobe.com/go/acrobatdctracks).
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>Explorador Android nativo en Android™ 4.4 y superior</td> 
   <td>Todas las actualizaciones</td> 
  </tr> 
 </tbody> 
</table>
...
Los requisitos de software de terceros para AEM Forms en JEE se documentan en la sección &quot;Requisitos del sistema&quot; de sus respectivos documentos de producto. Puede acceder a toda la documentación desde [https://adobe.com/go/learn_aemforms_documentation_64_es](https://adobe.com/go/learn_aemforms_documentation_64_es) .
