...
>[!NOTE]
>
>* Para obtener una lista completa de las excepciones a las plataformas de servidor admitidas, consulte [Excepciones a las plataformas de servidor admitidas](#exceptions-to-supported-server-platforms).
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Descargue el controlador del <a href="https://www-01.ibm.com/support/docview.wss?uid=swg21363866" target="_blank">sitio Web de IBM</a></p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>Plataforma de aplicaciones empresariales (EAP) 7.0.6 <sup>[1] [4] [5] [7] [8][11]</sup> de JBoss® Enterprise Application Platform (EAP)</p> </td> 
   <td><p>A: Admitido</p> </td> 
...
1. AEM Forms en JEE no admite Oracle WebLogic e IBM® WebSphere® con MySQL.
...
* AEM Forms en JEE soporta diversos software de terceros según nuestra [Política de soporte de software de terceros](#third-party-patch-support-policy).
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>Sun Solaris</td> 
   <td>Procesador UltraSPARC® IIIi, 1,5 GHz<br /> Contenedores Solaris (Zones) particionado<br /> RAM: 6 GB (SO de 64 bits con JVM de 64 bits)<br /> Espacio libre en disco: 6 GB de espacio temporal más 22 GB<br /> para AEM Forms en JEE</td> 
  </tr> 
  <tr> 
   <td>IBM AIX</td> 
   <td>P6 pSeries 520 (Modelo 52A) 9131-52A, procesador de 1,8 GHz<br /> LPAR particionado<br /> RAM: 6 GB (SO de 64 bits con JVM de 64 bits)<br /> Espacio libre en disco: 6 GB de espacio temporal más 22 GB<br /> para AEM Forms en JEE</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li><strong>Entorno con Sun SPARC:</strong> UltraSPARC V o posterior</li> 
...
Los requisitos de software de terceros para AEM Forms en JEE están documentados en la sección &quot;Requisitos del sistema&quot; de sus respectivos documentos de productos. Puede acceder a toda la documentación en [https://adobe.com/go/learn_aemforms_documentation_64](https://adobe.com/go/learn_aemforms_documentation_64).
