...
El uso de DDX y el servicio Assembler para llamar a otros servicios de ciclo LiveC puede simplificar el diagrama de proceso. Incluso puede reducir el esfuerzo que invierte en personalizar los flujos de trabajo. (Consulte también [Uso de AEM Document Services mediante programación](https://helpx.adobe.com/experience-manager/6-4/forms/using/aem-document-services-programmatically.html))
