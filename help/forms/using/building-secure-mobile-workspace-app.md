...
1. Busque y abra el archivo `LC Enterprise.entitlements` en el Xcode para editarlo. En las autorizaciones **XCode, **agregue el mismo par clave-valor que está presente en el perfil de aprovisionamiento.
