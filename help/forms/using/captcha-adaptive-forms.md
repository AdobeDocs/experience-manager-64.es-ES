...
1. Configure el servicio en la nube para reCAPTCHA.
   ...
   1. En el cuadro de diálogo Editar componente, especifique el sitio y las claves secretas obtenidas en el paso 1. Toque **[!UICONTROL Guardar configuración]** y luego toque **[!UICONTROL Aceptar]** para completar la configuración.
