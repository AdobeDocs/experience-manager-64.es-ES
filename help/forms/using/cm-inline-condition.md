...
Si usa condición dentro de la línea y repetir en comunicaciones interactivas y cartas, puede crear comunicaciones que sean muy contextuales y estén bien estructuradas.
...
Para obtener más información, consulte Crear regla en el texto en [Textos en comunicaciones interactivas](/help/forms/using/texts-interactive-communications.md).
...
1. Realice lo siguiente para construir una condición para evaluar si el texto seleccionado/condicional aparece en la carta y, a continuación, pulse la marca de verificación para guardar la expresión:
   ...
   Para obtener más información sobre la creación de expresiones, consulte **Crear expresiones y funciones remotas con el generador de expresiones** en [Generador de expresiones](/help/forms/using/expression-builder.md). El valor especificado en la expresión debe ser compatible con el elemento del diccionario de datos. Para obtener más información, consulte [Diccionario de datos](/help/forms/using/data-dictionary.md).
...
Es posible que deba insertar condiciones vacías dentro de la línea e incrustar texto y elementos DD más adelante. Administración de correspondencia le permite hacer eso.
