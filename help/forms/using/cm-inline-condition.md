...
Con las condiciones en línea y repetir en las comunicaciones interactivas y las letras, puede crear comunicaciones que sean muy contextuales y estén bien estructuradas.
...
Para obtener más información, consulte Crear regla en el texto de [Textos en comunicaciones interactivas](/help/forms/using/texts-interactive-communications.md).
