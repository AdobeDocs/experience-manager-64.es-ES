...
Puede utilizar Adobe Analytics para detectar patrones de interacción y problemas que los usuarios afrontan al utilizar formularios adaptables, formularios HTML5 y comunicación interactiva. De forma predeterminada, Adobe Analytics rastrea y almacena información sobre los siguientes parámetros:
...
1. Para asignar variables de Analytics con variables definidas en el componente, arrastre una variable desde el Buscador de contenido de AEM a un campo del componente de seguimiento.
   ...
   ![Asignar variables de AEM con variables de Adobe Analytics](assets/analytics.png)
...
1. Haga clic en **Forms > Formularios y documentos**, seleccione un formulario o documento y haga clic en **Habilitar Analytics**. El análisis está habilitado.
   ...
   **A.** Botón Habilitar Analytics **B.** Formulario seleccionado
   ...
   Para obtener información detallada sobre la visualización de informes de Forms Analytics, consulte [Visualizar y compreder los informes de AEM Forms Analytics](/help/forms/using/view-understand-aem-forms-analytics-reports.md)
