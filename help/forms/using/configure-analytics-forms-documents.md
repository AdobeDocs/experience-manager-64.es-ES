...
1. En la esquina superior izquierda, haga clic en **Adobe Experience Manager** > **Herramientas** ![herramientas](assets/tools.png)> **Cloud Services** > **Cloud Services heredados**.
...
1. Haga clic en **Forms > Forms y documentos**, seleccione un formulario o documento y haga clic en **Habilitar Analytics**. El análisis está habilitado.
   ...
   **A.** Botón Habilitar Analytics **B.** Formulario seleccionado
   ...
   Para obtener información detallada sobre la visualización de informes de análisis de formularios, consulte [Visualización y comprensión de los informes de análisis de AEM Forms](/help/forms/using/view-understand-aem-forms-analytics-reports.md)
