...
1. Inicie sesión en la instancia de autor de AEM y vaya a **Adobe Experience Manager** > **Forms** > **Forms &amp; Documents**. La dirección URL predeterminada es [http://localhost:4502/aem/forms.html/content/dam/formsanddocuments](http://localhost:4502/aem/forms.html/content/dam/formsanddocuments).
1. Pulse **Crear** y seleccione **Formulario adaptable**. Aparece una opción para seleccionar una plantilla. Pulse la plantilla **En blanco** para seleccionarla y pulse **Siguiente**.

1. Aparece una opción para **Agregar propiedades**. Los campos **Title** y **Name** son obligatorios:
...
1. Toque **Crear**. Se crea un formulario adaptable y aparece un cuadro de diálogo para abrir el formulario y editarlo. Pulse **Abrir** para abrir el formulario recién creado en una nueva pestaña. El formulario se abre para su edición. También muestra la barra lateral para personalizar el formulario recién creado según las necesidades.
...
1. Pulse ![alternar panel lateral](assets/toggle-side-panel.png) > ![treeexpandall](assets/treeexpandall.png). Se abre el navegador de componentes. Arrastre el componente **Header** desde el navegador de componentes al formulario adaptable.
1. Toque **Logotipo**. Aparecerá la barra de herramientas. Pulse ![aem_6_3_edit](assets/aem_6_3_edit.png) en la barra de herramientas, escriba **We.Retail** y pulse ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Arrastre el componente **Pie de página** de ![treeexpandall](assets/treeexpandall.png) al formulario adaptable. En esta fase, el formulario tiene el siguiente aspecto:
...
1. Arrastre un componente **Cuadro numérico** antes del componente de pie de página. Abra las propiedades del componente, establezca los valores enumerados en la tabla siguiente, Pulse ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Arrastre un componente **Email** antes del componente de pie de página. Abra las propiedades del componente, establezca los valores enumerados en la tabla siguiente y pulse ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Arrastre un componente **Archivo adjunto** antes del componente de pie de página. Abra las propiedades del componente, establezca los valores enumerados en la tabla siguiente y pulse ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Arrastre un componente **Botón de envío** al formulario adaptable. Colóquelo antes del componente de pie de página. Abra las propiedades del componente, cambie Nombre de elemento a **address_add_update_submit** y pulse ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png). La presentación del formulario es completa y el formulario tiene el aspecto siguiente:
...
1. Pulse **Contenedor de formulario** en el navegador de contenido y pulse ![cmppr](assets/cmppr.png). El navegador de propiedades se abre a la izquierda.
1. Vaya a **Envío** > **Enviar acción**. Seleccione **Send Email**. Especifique los siguientes valores y pulse ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
Los formularios adaptables también proporcionan una opción para emular la experiencia de un formulario para varios dispositivos. Por ejemplo, iPhone, iPad y Escritorio. Puede utilizar las opciones **Preview** y **Emulator** ![rule](assets/ruler.png) junto con otras para obtener una vista previa de un formulario para dispositivos de diferentes tamaños de pantalla.
...
1. Rellene los campos del formulario y pulse **Enviar**. El formulario se envía y se le redirige a la página **Gracias** predeterminada. También puede especificar una página de agradecimiento personalizada. Para obtener más información, consulte [Configuración de la página de redireccionamiento](/help/forms/using/configuring-redirect-page.md).
