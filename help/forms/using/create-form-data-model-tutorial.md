...
Para obtener más información sobre la integración de datos de formulario y el modelo de datos de formulario, consulte [AEM Forms Data Integration](data-integration.md).
...
* Base de datos MySQL con datos de ejemplo como se indica en la sección [Configure the database](#step-set-up-the-database).
