...
1. Configure la base de datos MySQL como una fuente de datos:
   ...
   1. En el cuadro de diálogo de configuración, especifique los siguientes detalles:
      ...
      * **** Consulta de validación: Especifique una consulta SQL SELECT para validar conexiones desde el grupo. La consulta debe devolver al menos una fila. Por ejemplo, **seleccione &amp;ast; de los detalles del cliente**.
