...
**Plantilla de impresión:** [create_first_ic_print_template](/help/forms/using/create-templates-print-web.md)
...
1. Toque **Editar** para abrir la comunicación interactiva en el panel derecho.
1. Ejecute los pasos 6 a 15 de la sección [Crear comunicación interactiva para canal de impresión](#create-interactive-communication-for-print-channel).
...
1. Como la casilla **Usar Imprimir como Canal principal para Web** está seleccionada en el paso 4, el contenido y los enlaces se generan automáticamente para el canal Web desde el canal Imprimir.
   ...
   ![cancel_herencia_web_canal](assets/cancel_inheritance_web_channel.png)
...
1. Repita los pasos 13 a 18 de [Crear comunicación interactiva para canal Web](#create-interactive-communication-for-web-channel) para insertar los hipervínculos **Pagar ahora** y **Suscribirse** en el canal Web de la Comunicación interactiva.
