...
1. Toque **Editar** para abrir la comunicación interactiva en el panel derecho.
1. Ejecute los pasos 6 a 15 de la sección [Crear comunicación interactiva para el canal](#create-interactive-communication-for-print-channel) de impresión.
...
1. Repita los pasos 13 a 18 de [Crear comunicación interactiva para canal](#create-interactive-communication-for-web-channel) web para insertar los hipervínculos **Pagar ahora** y **Suscribirse** en el canal web de la comunicación interactiva.
