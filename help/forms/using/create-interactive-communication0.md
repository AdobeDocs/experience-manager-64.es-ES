...
1. Repita los pasos 13 a 18 de [Crear comunicación interactiva para canal](/help/forms/using/create-interactive-communication0.md#create-interactive-communication-for-web-channel) web para insertar los hipervínculos **Pagar ahora** y **Suscribirse** en el canal web de la comunicación interactiva.
