...
* [Paquete de compatibilidad](https://helpx.adobe.com/in/experience-manager/6-4/forms/using/compatibility-package.html). Instale el paquete de compatibilidad para ver la opción **Cartas** en la página **Formularios**.
