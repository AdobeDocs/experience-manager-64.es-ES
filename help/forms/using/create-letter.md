...
* [Paquete](https://helpx.adobe.com/in/experience-manager/6-4/forms/using/compatibility-package.html) de compatibilidad. Instale el Paquete de compatibilidad para vista de la opción **Letras** en la página **Forms**.

* La letra XDP ([layout](/help/forms/using/document-fragments.md)).
* Otros XDP ([fragmentos de diseño](/help/forms/using/document-fragments.md)) que forman partes de la letra. Los XDP\Layouts se crean en [Designer](https://help.adobe.com/en-US/AEMForms/6.1/DesignerHelp/).
