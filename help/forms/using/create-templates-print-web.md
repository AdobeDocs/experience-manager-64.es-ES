...
1. Select **Archivo** > **Guardar como** para guardar el archivo en el sistema de archivos local:
   ...
   Una vez creada una plantilla XDP para fragmento de diseño con Forms Designer, debe [cargar](/help/forms/using/create-templates-print-web.md#upload-xdp-template-to-the-aem-forms-server) se envía al servidor de AEM Forms para que la plantilla esté disponible para usar durante la creación de fragmentos de diseño.
