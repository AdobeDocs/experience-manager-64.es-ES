...
* Instale el complemento [](/help/forms/using/installing-configuring-aem-forms-osgi.md) AEM Forms en la instancia de creación.
...
* Vista previa y envío de un formulario adaptable
   ...
   [ ![consulte-the-guide-sm](assets/see-the-guide-sm.png)](create-adaptive-form.md)
...
* Probar el modelo de datos de formulario y los servicios configurados con datos de prueba
   ...
   [ ![consulte-the-guide-sm](assets/see-the-guide-sm.png)](create-form-data-model.md)
...
* Uso de fuentes web en un tema personalizado
   ...
   [ ![consulte-the-guide-sm](assets/see-the-guide-sm.png)](style-your-adaptive-form.md)
...
Para obtener más información sobre el SDK, consulte [Uso de pruebas automatizadas con AEM Adaptive Form](/help/forms/using/calvin.md).

## Paso 6: Publicación del formulario adaptable {#step-publish-your-adaptive-form}

![12-publish-your-adaptive-form-_small](assets/12-publish-your-adaptive-form-_small.png)

Los formularios adaptables se pueden publicar como formularios independientes (aplicación de una sola página), incluir en la página [de](/help/forms/using/embed-adaptive-form-aem-sites.md)sitios de AEM o enumerar en un sitio de AEM mediante [Forms Portal](/help/forms/using/introduction-publishing-forms.md).
