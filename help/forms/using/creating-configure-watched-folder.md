...
* Una carpeta vigilada tiene varias propiedades, consulte [Propiedades de las carpetas vigiladas](/help/forms/using/watched-folder-in-aem-forms.md#watchedfolderproperties).
...
1. Pulse **Avanzadas**. La pestaña Avanzadas contiene más campos. La mayoría de estos campos contienen un valor predeterminado.
   ...
   * **Incluir archivos con patrón:** especifique una lista delimitada por punto y coma (;) de patrones que la carpeta vigilada usa para determinar qué carpetas y archivos analizar y recoger. Por ejemplo, si el Patrón de archivo de inclusión es input&amp;ast;, todos los archivos y carpetas que coincidan con input&amp;ast; se recogerán. Para obtener más información, consulte [Ayuda de administración](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
