...
1. Haga clic en el ![aem6forms_add](assets/aem6forms_add.png) en la barra de herramientas y, a continuación, seleccione **[!UICONTROL Crear carpeta]**.
...
1. Haga clic en la edición ![aem6forms_edit](assets/aem6forms_edit.png) en la barra de herramientas.
