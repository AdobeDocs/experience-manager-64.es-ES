...
* Encapsule la etiqueta icono dentro de la etiqueta anclaje en lugar del texto. Por ejemplo, el *nuevo código *que aparece a continuación encapsula la etiqueta icon dentro de la etiqueta anchor :
