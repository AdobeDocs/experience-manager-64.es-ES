...
* Encapsular etiqueta de icono dentro de la etiqueta de anclaje en lugar de texto. Por ejemplo, el *nuevo código *que aparece a continuación encapsula la etiqueta icon dentro de la etiqueta anchor :
