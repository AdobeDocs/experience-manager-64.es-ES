...
* **htmlStyle**  y  **pdfStyle**: Estilo de visualización para los iconos HTML y PDF, respectivamente, utilizados para la renderización. Los valores válidos son &quot;**__FP_display_none**&quot; o **blank**
...
1. **Uso de propiedades** de configuración: El componente Búsqueda y lista tiene varias configuraciones que puede utilizar en la interfaz de usuario. Por ejemplo, para mostrar texto de información del objeto HTML guardado mediante el cuadro de diálogo de edición, utilice el atributo **${config-htmlLinkText}.** Del mismo modo, para el texto de información del objeto PDF, utilice el atributo **${config-pdfLinkText}** .
