...
1. Ubique los registros del servidor como se indica en [Registros para los formularios HTML5](/help/forms/using/enable-logs.md). Compruebe si hubo algún error en los registros del servidor durante el envío.

## Problema: Los mensajes de error localizados no se muestran {#problem-localized-error-messages-do-not-display}

1. Procese el formulario con el parámetro de consulta adicional **debugClientLibs=true** en el navegador de escritorio y, a continuación, vaya a Herramientas de desarrollo -> Recursos y busque el archivo I18N.css.
