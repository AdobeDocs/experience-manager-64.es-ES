...
Cuando un formulario XDP se procesa como HTML mediante el paquete de formularios móviles implementado en CRX, también agrega javascript adicional `FormBridge` al formulario, que expone diferentes métodos para guardar y enviar datos de formulario.
