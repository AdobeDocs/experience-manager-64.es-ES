...
Para permitir que el envío de un formulario adaptable aparezca en la pestaña Envíos, establezca la **acción Enviar** como **[Acción de envío del portal de formularios](/help/forms/using/configuring-submit-actions.md).** También puede activar la opción Envío del portal de formularios. Cada vez que un usuario envíe el formulario, este se agregará a la pestaña envíos.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>Especifica el diseño que se utiliza para la lista Formularios en borrador.</p> <p><strong>Nota:</strong> No utilice la opción Predeterminado (obsoleto).<br /> </p> </td>
  </tr>
  <tr>
