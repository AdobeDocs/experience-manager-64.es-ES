...
1. Para las páginas que utilizan una plantilla dinámica, realice los siguientes pasos:
   ...
   1. Pulse **Contenedor de diseño** y pulse ![FeedManagement](assets/FeedManagement.png). En la pestaña **Componentes permitidos**, habilite **Predicados de servicios de documentos y Servicios de documentos** y pulse ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
