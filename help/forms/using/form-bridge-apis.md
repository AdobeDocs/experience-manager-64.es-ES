...
La API de **Connect** acepta un controlador como argumento. Después de crear una conexión correcta entre el formulario HTML5 basado en XFA y Form Bridge, se invoca el controlador.
...
* **Entrada**:
   ...
   * **context**: El objeto en el que se establece el contexto (esto) de la función *handler *function.
