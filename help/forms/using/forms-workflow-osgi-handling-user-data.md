...
description: Los flujos de trabajo de AEM centrados en Forms le permiten automatizar procesos empresariales reales centrados en Forms. Profundizar en los almacenes de datos y datos de los usuarios. Obtenga información sobre cómo acceder y eliminar datos de usuario.
seo-description: Los flujos de trabajo de AEM centrados en Forms le permiten automatizar procesos empresariales reales centrados en Forms. Profundizar en los almacenes de datos y datos de los usuarios. Obtenga información sobre cómo acceder y eliminar datos de usuario.
...
* Envío de una aplicación desde la aplicación AEM Forms
...
1. Vaya a la consola CRXDE Lite, vaya a la ruta de carga útil de una instancia de flujo de trabajo y elimine el nodo `payload`.
...
* [Cómo acceder mediante programación al JCR AEM](/help/sites-developing/access-jcr.md)
