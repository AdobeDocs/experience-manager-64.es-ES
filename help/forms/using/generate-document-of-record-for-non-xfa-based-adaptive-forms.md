...
* [Plantillas de formulario](/help/forms/using/creating-adaptive-form.md#p-create-an-adaptive-form-based-on-an-xfa-form-template-p)
   ...
   Permite seleccionar una plantilla XFA para el formulario adaptable. Al seleccionar una plantilla XFA, puede utilizar el archivo XDP asociado para el documento del registro como se describe anteriormente.
...
1. En la sección Documento de la configuración de la plantilla de registro de la ficha Modelo de formulario, seleccione una de las siguientes opciones.
   ...
   **[!UICONTROL Seleccione esta opción para utilizar un archivo XDP como plantilla base para definir el estilo y el aspecto del documento del registro. Al seleccionar esta opción, se muestran todos los archivos XDP disponibles en el repositorio de AEM Forms. Seleccione el archivo apropiado.]**

   **Seleccione Plantilla de Forms como plantilla base para generar el Documento de** registrosSeleccione esta opción para utilizar un archivo XDP como plantilla base para definir el estilo y la apariencia del documento de registros. Al seleccionar esta opción, se muestran todos los archivos XDP disponibles en el repositorio de AEM Forms. Seleccione el archivo adecuado.
