...
No debe instalar ni configurar AEM Forms en JEE con un shell raíz. De forma predeterminada, los archivos se instalan en el directorio /opt, y el usuario que realiza la instalación necesita todos los permisos de archivo en /opt. De forma alternativa, se puede realizar una instalación en el directorio /user de un usuario individual en el que ya se tengan todos los permisos de archivo.
...
Para obtener información de seguridad adicional para su sistema operativo, consulte [&quot;Información de seguridad del sistema operativo&quot;](https://helpx.adobe.com/es/aem-forms/6-1/hardening-security/general-security-considerations.html#operating_system_security_information).
...
1. Asigne a la nueva cuenta de usuario los permisos Leer y ejecutar, Listar contenido de carpeta y Leer para el elemento de directorios de contenido web de AEM Forms en JEE.
...
Para obtener información sobre herramientas específicas del proveedor, consulte [&quot;Información de seguridad de la base de datos&quot;](https://helpx.adobe.com/es/aem-forms/6-1/hardening-security/general-security-considerations.html#database_security_information).
...
1. Asigne a la nueva cuenta de usuario permisos de lectura y ejecución, contenido de la carpeta de lista y lectura para AEM Forms en los directorios de contenido web JEE.
...
Después de iniciar sesión en la consola de administración, es posible examinar la lista de directorios de la consola modificando la URL. Por ejemplo, si cambia la URL a una de las siguientes, puede aparecer un listado de directorios:
