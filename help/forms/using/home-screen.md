...
Puede cambiar la pantalla de inicio predeterminada de la aplicación desde la ficha **[Configuración general](/help/forms/using/update-general-settings.md)** de la aplicación o desde la ficha **Preferencia** en el área de trabajo HTML.
