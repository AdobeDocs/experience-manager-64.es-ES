...
Puede aprobar varias tareas del mismo tipo. Una vez seleccionada una tarea para aprobación, solo permanecerán habilitadas las tareas con el mismo proceso, con los mismos nombres de tarea y las mismas opciones de ruta. Consulte [Uso de listas de tareas pendientes](/help/forms/using/todo-lists.md) para obtener detalles de implementación.
...
El artículo [personalización](introduction-customizing-html-workspace.md) explica los tipos de dichas personalizaciones.
