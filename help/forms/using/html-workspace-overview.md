  ...
  <tr>
   ...
   <td>
    <ol> 
     ...
     <li><a href="/help/forms/using/creating-new-login-screen.md">Crear una nueva pantalla de inicio de sesión</a></li> 
...
El artículo [Personalización](introduction-customizing-html-workspace.md) explica los tipos de estas personalizaciones.
