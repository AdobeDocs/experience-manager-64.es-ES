...
Cuando un usuario envía el formulario, el explorador envía el estado del formulario en formato JSON al [proxy del servicio de envío](/help/forms/using/service-proxy.md); a continuación, el proxy del servicio de envío genera un XML de datos utilizando datos JSON y envía ese XML de datos para enviar el extremo.
