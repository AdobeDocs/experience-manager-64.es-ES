...
1. Pulse **Crear** > **Cargar archivo**. Aparecerá un cuadro de diálogo de carga de formularios o paquetes.
...
1. Pulse herramientas ( ![tools-1](assets/tools-1.png)) y, a continuación, pulse **Forms**.
...
1. Pulse el enlace **Download Exported Package** para descargar el archivo del paquete.
   ...
   Para añadir los recursos del paquete a otra instancia de Gestión de Correspondencia, [importe el paquete a una instancia de AEM Forms](/help/forms/using/import-export-forms-templates.md#p-upload-forms-documents-assets-p).
...
>[!NOTE]
>
>Al importar recursos antiguos de la gestión de correspondencia para la migración, inicie sesión con una cuenta de administrador. Para obtener más información sobre la migración de recursos antiguos de la administración de correspondencia, consulte [Migrar recursos y documentos de AEM Forms](/help/forms/using/migration-utility.md).
...
1. Haga clic en **[!UICONTROL Edit]** y abra la pestaña **[!UICONTROL Filters]**. Haga clic en **[!UICONTROL Agregar filtro]**. Especifique la ruta de la aplicación de flujo de trabajo. Por ejemplo, /etc/fd/dashboard/startpoints/homemortgage.
