...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p><a href="http://adobe.com/go/learn_aemforms_firstapp_ds_65">Creación de la primera aplicación</a><br /> de AEM Forms <br /> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p><a href="https://www.adobe.com/account/sign-in.supportportal.html">Póngase en contacto con el servicio de asistencia</a><br /> empresarial de Adobe <br /> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Descargue e instale la versión más reciente de Adobe AIR (desde <a href="http://www.adobe.com/">www.adobe.com</a>) necesaria para el cliente de ayuda de comunidad, integrado con Workbench.
* Java™ Runtime Environment (JRE) 6.0 actualización 22 o posterior se actualiza a 6.0 *Nuevo para 10*.
...
>[!NOTE]
>
>Si tiene Adobe® Acrobat® X instalado en el equipo, asegúrese de desinstalarlo antes de instalar Workbench. Después de instalar Workbench, puede volver a instalar Acrobat.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Ninguna.  
La instalación de Workbench detecta una instancia de Designer en el equipo que se instaló con Acrobat Pro o Acrobat Pro Extended.
...
<br /> <br /> </p> </td> 
  ...
  <tr> 
   ...
   <td><p>Ninguna. La versión de Designer incluida con Workbench solo está disponible en inglés. El instalador de Workbench no reinstalará una nueva versión de Designer. En su lugar, se realizará una revisión de una versión actualizada, incluida con el instalador de Workbench. <br /> Esto también le permite utilizar la versión localizada de Designer en Workbench. <br /> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Haga clic en **Cambiar** y, a continuación, en **Siguiente**.
1. Seleccione **Modificar** y, a continuación, haga clic en **Siguiente**.
1. Seleccione **Adobe Designer**, seleccione **Esta función no estará disponible** y, a continuación, haga clic en **Siguiente**
...
1. Los siguientes elementos ya están instalados en el equipo:
   * **Workbench**: Para ejecutar Workbench desde el menú Inicio, seleccione Todos los programas > Formularios AEM > Workbench si decide almacenar la carpeta de accesos directos en ella. Para obtener más información, consulte la documentación Uso de Workbench.
...
Los procesos de AEM Forms Update 1 y LiveCycle ES2 se pueden actualizar a aplicaciones de AEM Forms mediante el Asistente para la actualización. Consulte Actualización de la documentación de artefactos heredados en la Ayuda de Workbench para obtener más información.
...
* Workbench_DVD/extra/eclipseDescargue e instale Eclipse 3.6 desde <a href="https://www.eclipse.org/downloads/">www.eclipse.org/downloads</a>.
...
* Complemento &#39;org.apache.commons.lang_2.3.0&#39; [n/a]: Esto se encuentra en la &#39;Lista de tareas de Mylyn (obligatoria)&#39; [org.eclipse.mylyn_feature.feature.group]
   </p> </td> 
  </tbody>
  </table>
...
1. En el cuadro de diálogo Agregar repositorio, haga clic en Local y busque el directorio en el que la instalación de Workbench guardó el archivo ZIP del complemento, seleccione Workbench-updatesite.zip y, a continuación, haga clic en Abrir.
