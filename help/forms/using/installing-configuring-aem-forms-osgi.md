...
Instale y configure formularios adaptables, formularios PDF y formularios HTML5. Configure Adobe Analytics y Adobe Target para formularios adaptables a fin de analizar el uso de formularios y dirigir a los usuarios en función de su perfil.
...
1. Agregue el paquete **[!UICONTROL sun.util.calendar]** al campo de la **[!UICONTROL lista blanca]** . Haga clic en **[!UICONTROL Guardar]**.
