...
Instale y configure formularios adaptables, PDF forms y formularios HTML5. Configure Adobe Analytics y Adobe Target para formularios adaptables a fin de analizar el uso de formularios y usuarios de destinatario en función de su perfil.
...
Antes de comenzar a instalar y configurar AEM Forms de capacidad de captura de datos, asegúrese de que:
