...
AEM Forms es una potente plataforma de clase empresarial. El flujo de trabajo centrado en Forms en OSGi es solo una de las capacidades de AEM Forms. Para obtener la lista completa de funcionalidades, consulte [Introducción a AEM Forms](/help/forms/using/introduction-aem-forms.md).

>[!NOTE]
>
>Con el flujo de trabajo centrado en formularios en OSGi, puede generar e implementar rápidamente flujos de trabajo para diversas tareas en la pila OSGi, sin tener que instalar la funcionalidad de administración de procesos completa en la pila JEE. Consulte una [comparación](/help/forms/using/capabilities-osgi-jee-workflows.md) de los flujos de trabajo de AEM centrados en Forms en OSGi y Process Management en JEE para conocer las diferencias y similitudes en las capacidades.
>
...
>[!NOTE]
>
>Pasar a la [Pasos siguientes](#next-steps) del documento, si ya ha instalado AEM Forms en OSGi como se explica en la sección [instalación y configuración de las funcionalidades de captura de datos](/help/forms/using/installing-configuring-aem-forms-osgi.md) artículo.
