...
# Instalar y configurar las comunicaciones interactivas {#install-and-configure-interactive-communications}
...
AEM Forms es una potente plataforma de clase empresarial. La comunicación interactiva es sólo una de las funciones de AEM Forms. Para obtener la lista completa de las capacidades, consulte [Introducción a AEM Forms](/help/forms/using/introduction-aem-forms.md).
