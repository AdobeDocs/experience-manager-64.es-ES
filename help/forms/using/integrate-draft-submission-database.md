...
1. Vaya a `/libs/fd/af/runtime/clientlibs/guideRuntime`y añada la variable `fp.validation` a la variable **embed** propiedad.

1. Vaya a /libs/fd/af/runtime/clientlibs/guideRuntimeWithXFA y añada la variable `fp.validation` valor **embed** propiedad.
