...
Comience creando una plantilla de gestión de correspondencia de ejemplo que se procesa en el espacio de trabajo de AEM Forms. Para obtener más información, consulte [Creación de una plantilla](/help/forms/using/create-letter.md)de carta.
