...
Para ver ejemplos específicos de estas personalizaciones, consulte los temas de Ayuda que se proporcionan al final de este artículo. Elija entre las [Paquete de envío](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p) o [Paquete de desarrollo](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p), según la plantilla que se personalice.
