...
# Introducción a Personalización AEM espacio de trabajo de formularios {#introduction-to-customizing-aem-form-workspace}
...
* Paquetes CRX para perfiles de Envío, Depuración y Desarrollo (mencionados a continuación en los paquetes [](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)CRX).
