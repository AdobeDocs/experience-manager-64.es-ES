...
Para buscar formularios con la API de REST, envíe una solicitud de GET al servidor en `https://[server]:[port]/libs/fd/fm/content/manage.json` los parámetros de consulta que se describen a continuación.
