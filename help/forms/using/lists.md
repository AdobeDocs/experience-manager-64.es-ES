...
1. Se abre un editor de texto e introduzca el texto. Utilice la barra de herramientas situada en la parte superior de la página para dar formato al texto, insertar condiciones, vínculos y saltos de página.
   ...
   * **Vínculo**: Inserte un vínculo de hipertexto en el texto. Toque **[!UICONTROL Link]**, especifique el vínculo en el campo **[!UICONTROL URL]**, elimine el nombre de objeto predeterminado del campo **[!UICONTROL Texto alternativo]** y pulse ![Guardar](assets/save_icon.svg).
