...
1. Toque **Crear** > **Texto.** O bien, seleccione un recurso de texto y toque  **Editar**.
...
1. Se abre un editor de texto, introduzca el texto. Utilice la barra de herramientas situada en la parte superior de la página para dar formato al texto, insertar condiciones, vínculos y saltos de página.
   ...
   * **Vínculo**: Inserte un vínculo de hipertexto en el texto. Toque **[!UICONTROL Vínculo]**, especifique el vínculo en el campo **[!UICONTROL URL]**, quite el nombre de objeto predeterminado del campo **[!UICONTROL Texto alternativo]** y toque ![Guardar](assets/save_icon.svg).
...
1. En el panel de datos, arrastre y suelte los elementos del diccionario de datos y los elementos del marcador de posición al texto.
   ...
   **Figura:Valores del elemento** *Marcador de posición en la vista CCR rellenados a partir de las variables del diccionario de datos, tal como se especifica en el archivo de datos de ejemplo*
...
**Nota:** Si introduce caracteres especiales en el cuadro de texto Buscar, la opción Palabra completa estará desactivada.
...
1. Toque la ficha **Tabla** y especifique la siguiente información para el diseño:
   ...
   * **Proporción de anchura:** proporción de los anchos de columna de la tabla.
   ...
   Para ver un ejemplo detallado del uso de tablas estáticas y dinámicas en fragmentos de diseño, consulte [Ejemplo con archivos de ejemplo: utilizando tablas estáticas y dinámicas en una letra](create-letter.md#insert-data-modules-and-layout-fragments-in-a-letter-and-configure-them).
