...
Si es el desarrollador o el propietario de un sitio, puede personalizar el portal de formularios, la interfaz de usuario final de AEM Forms, para reflejar los metadatos que utiliza en su organización. Para obtener más información sobre el portal de formularios, consulte [Introducción a la publicación de formularios en un portal](/help/forms/using/introduction-publishing-forms.md).
