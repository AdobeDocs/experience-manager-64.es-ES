...
Para obtener más información sobre los informes de análisis de formularios, consulte [Visualización y comprensión de los informes de análisis de AEM Forms](/help/forms/using/view-understand-aem-forms-analytics-reports.md).
...
![Informe de resumen de ejemplo de la prueba A/B para un formulario adaptable](assets/ab-test-report-2.png)
