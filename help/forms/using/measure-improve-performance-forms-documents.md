...
Para crear y ejecutar pruebas A/B para sus formularios adaptables, configure Destinatario en AEM Forms como se describe en [Configurar e integrar Destinatario en AEM Forms](/help/forms/using/ab-testing-adaptive-forms.md#p-set-up-and-integrate-target-in-aem-forms-p).
...
Para obtener más información sobre los informes de análisis de formularios, consulte [Visualización y comprensión de informes de análisis de AEM Forms](/help/forms/using/view-understand-aem-forms-analytics-reports.md).
...
Para obtener más información sobre la creación de una prueba A/B para un formulario adaptable, consulte [Prueba A/B de formularios adaptables](/help/forms/using/ab-testing-adaptive-forms.md).
