...
description: AEM Forms se integra con las soluciones Adobe Target y Adobe Analytics, las cuales le permiten medir y mejorar el rendimiento y la tasa de conversión de los formularios.
...
Para ver los pasos detallados, consulte [Configuración de análisis e informes para formularios adaptables](/help/forms/using/configure-analytics-forms-documents.md).

**Configuración de Target**

Para crear y ejecutar pruebas A/B en los formularios adaptables, configure Target en AEM Forms como se describe en [Configuración e integración de Target en AEM Forms](/help/forms/using/ab-testing-adaptive-forms.md#p-set-up-and-integrate-target-in-aem-forms-p).
...
Para obtener más información sobre los informes de análisis de formularios, consulte [Ver y comprender los informes de análisis de AEM Forms](/help/forms/using/view-understand-aem-forms-analytics-reports.md).
...
Para obtener más información sobre la creación de una prueba A/B para un formulario adaptable, consulte [Pruebas A/B para formularios adaptables](/help/forms/using/ab-testing-adaptive-forms.md).

![Informe de resumen de ejemplo de la prueba A/B de un formulario adaptable](assets/ab-test-report-2.png)
