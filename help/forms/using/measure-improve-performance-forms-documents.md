...
description: AEM Forms se integra con las soluciones de Adobe Target y Adobe Analytics que le permiten medir y mejorar el rendimiento y la tasa de conversión de los formularios.
seo-description: AEM Forms se integra con las soluciones de Adobe Target y Adobe Analytics que le permiten medir y mejorar el rendimiento y la tasa de conversión de los formularios.
...
AEM Forms se integra con las soluciones de [Adobe Marketing Cloud](https://www.adobe.com/marketing-cloud.html) , [Adobe Analytics](https://www.adobe.com/marketing-cloud/web-analytics.html) y [Adobe Target](https://www.adobe.com/marketing-cloud/testing-targeting.html) , que le pueden ayudar a supervisar y analizar el rendimiento de los formularios y le permiten experimentar e identificar la experiencia que conduce a una mejor tasa de conversión.
...
### Componentes y funciones de AEM Forms {#aem-forms-components-and-features-involved}
...
1. Creación de un grupo de informes en Adobe Analytics
1. Creación de la configuración del servicio de nube en AEM
1. Crear un marco de servicios en la nube en AEM
1. Configuración del servicio de configuración de AEM Forms Analytics en AEM
...
Para crear y ejecutar pruebas A/B para sus formularios adaptables, configure Target en AEM Forms como se describe en [Configuración e integración de Target en AEM Forms](/help/forms/using/ab-testing-adaptive-forms.md#p-set-up-and-integrate-target-in-aem-forms-p).
...
1. En AEM Server, vaya a **Formularios > Formularios y documentos**.
...
**Informe de análisis de formularios**
...
>[!NOTE]
>
>Puede ver informes detallados y obtener información más detallada sobre sus clientes y sus interacciones con los formularios desde su cuenta de Analytics en Adobe Marketing Cloud.
...
Una vez que haya analizado estos puntos de datos y haya llegado a una hipótesis, realice los cambios necesarios en el formulario.

#### Paso 4: Validar el análisis y las correcciones {#step-validate-your-analysis-and-fixes}

En este paso, validará los cambios realizados en el formulario y verificará si afectan a la tasa de conversión.

**Ejecutar una prueba A/B**

La integración de AEM Forms con Target permite crear pruebas A/B para formularios adaptables. En las pruebas A/B, se presentan al azar diferentes experiencias de un formulario a los clientes en tiempo real para saber qué experiencia funciona mejor o genera más conversiones. Una vez que tenga datos significativos que indiquen que una experiencia ofrece una mejor conversión que la otra, puede declarar que las experiencias son las ganadoras y, a partir de ahora, se convierten en la experiencia predeterminada visible para todos los clientes.
...
![Un informe de resumen de muestra de la prueba A/B para un formulario adaptable](assets/ab-test-report-2.png)

## Best practices {#best-practices}

Las prácticas recomendadas reales son las que usted mismo se identifica al realizar este flujo de trabajo. Son exclusivos de su entorno y de sus requisitos. Capturar los conocimientos a través del flujo de trabajo y documentarlos como prácticas recomendadas.
...
* Realice variaciones mínimas (idealmente, de una en una) en la experiencia alternativa para saber qué impacto tuvo en la tasa de conversión.
