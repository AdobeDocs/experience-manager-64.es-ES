...
Sí, dado que los servicios de procesamiento y envío anteriores asociados al perfil de acción predeterminado eran diferentes, se tratan como una personalización de los formularios existentes. Al hacer clic en **[!UICONTROL Restaurar valores predeterminados]**, los servicios de renderización y envío predeterminados se establecen en su lugar.
