...
# Consultas ad hoc en el Sistema de informes de procesos {#ad-hoc-queries-in-process-reporting}
...
1. Ejecutar una búsqueda de proceso/tarea. Para obtener más información, consulte [Ejecución de una consulta de búsqueda de procesos](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p).
