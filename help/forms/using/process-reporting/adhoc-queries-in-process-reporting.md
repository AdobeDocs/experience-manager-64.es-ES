...
1. Para crear una consulta, haga clic en **Agregar** (+).
   ...
   **Definición de un filtro**
   ...
   1. Para añadir otro filtro a la consulta, haga clic en **Add(+)** a la derecha de la fila de filtro.

      Para eliminar un filtro de la consulta, haga clic en **Delete(-)** a la derecha de la fila de filtro.
...
1. Utilice las opciones de la esquina superior derecha de la variable **Informe** para realizar operaciones en el resultado de la consulta.
...
1. Ejecute una búsqueda de proceso/tarea. Para obtener más información, consulte [Ejecutar una consulta de búsqueda de proceso](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p).
