...
Para obtener más información sobre los informes predefinidos, consulte Informes [predefinidos en informes](pre-defined-reports-in-process-reporting.md)de proceso.

**** Consultas ad hoc: Este elemento contiene opciones para realizar búsquedas basadas en filtros para procesos y tareas.

Para obtener más información sobre consultas ad hoc, consulte Consultas [ad-hoc en informes](adhoc-queries-in-process-reporting.md)de procesos.
