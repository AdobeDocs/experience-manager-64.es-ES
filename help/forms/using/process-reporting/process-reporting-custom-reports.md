...
En el siguiente ejemplo de servicio se cuentan instancias de un proceso que está en **ejecución** y en estado **COMPLETE** al final de cada mes, trimestre y año.
...
1. Cree una IU independiente como se describe en [Creación de una sección de IU](#creating-a-separate-ui-nbsp) independiente.
1. Cree un `nt:unstructured` nodo secundario en el `/content/process-reporting-runtime/custom-reports` nodo para cada informe conectable.
