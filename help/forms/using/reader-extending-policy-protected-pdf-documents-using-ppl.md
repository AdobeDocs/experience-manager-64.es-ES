---
title: Reader amplía los documentos PDF protegidos por políticas mediante la biblioteca de protección portátil
seo-title: Reader amplía los documentos PDF protegidos por políticas mediante la biblioteca de protección portátil
description: 'Las extensiones de Reader permiten funciones interactivas en documentos Adobe PDF a través de Acrobat Reader. Puede utilizar la biblioteca de protección portátil (PPL) para que el lector extienda los documentos PDF protegidos con DRM. '
seo-description: 'Las extensiones de Reader permiten funciones interactivas en documentos Adobe PDF a través de Acrobat Reader. Puede utilizar la biblioteca de protección portátil (PPL) para que el lector extienda los documentos PDF protegidos con DRM. '
...
# Reader amplía los documentos PDF protegidos por políticas mediante la biblioteca de protección portátil {#reader-extending-policy-protected-pdf-documents-using-portable-protection-library}

Debe estar familiarizado con los conceptos de seguridad del documento, extensión del lector y lenguaje de programación Java para que el lector pueda ampliar los documentos PDF protegidos por políticas de seguridad del documento.

Puede utilizar la seguridad de documentos para restringir el acceso de documentos PDF específicos solo a usuarios autorizados. También puede determinar cómo un destinatario puede utilizar un documento protegido. Por ejemplo, puede especificar si los destinatarios pueden imprimir, copiar o editar texto de un documento protegido por una política de seguridad de documento. Para obtener más información sobre la seguridad de los documentos, consulte [sobre la seguridad](/help/forms/using/admin-help/document-security.md)de los documentos.

Puede utilizar extensiones de lector para activar funciones interactivas en documentos Adobe PDF a través de Acrobat Reader. Estas funciones interactivas normalmente solo están disponibles a través de Adobe Acrobat Professional y Standard. Para obtener más información sobre las funciones interactivas que la extensión de lector puede activar, consulte el servicio [](/help/forms/using/overview-aem-document-services.md)**Adobe Experience Manager Forms DocAssurance.**
...
## Reader amplía los documentos PDF protegidos por políticas de seguridad de documentos {#reader-extending-document-security-policy-protected-pdf-documents}
...
### Servicio Reader Extensions {#reader-extensions-service}
...
El servicio Reader Extensions es totalmente compatible con documentos PDF basados en PDF estándar 1.6 y posterior. Aparte de Acrobat Reader, los usuarios de terceros no necesitan ningún software o complemento adicional para utilizar los documentos PDF protegidos por políticas.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>inputFile</p> </td> 
   <td><p>Especifique InputStream que represente el documento PDF al que se van a aplicar los derechos de uso. Puede utilizar LiveCycle Rights Management o documentos protegidos por seguridad de AEM Forms.</p> </td> 
  </tr> 
  <tr> 
   <td><p>certFile</p> </td> 
...
Puede utilizar la API de `getDocumentUsageRights`Java para recuperar los derechos de uso de la extensión de lectura aplicados a un documento PDF protegido por una política. Al recuperar información sobre los derechos de uso, puede obtener información sobre las características que la extensión del lector ha habilitado para el documento PDF protegido por una política.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>inDoc</p> </td> 
   <td><p>Especifique InputStream que represente el documento PDF desde el que se van a recuperar los derechos de uso. Puede utilizar LiveCycle Rights Management o documentos protegidos por seguridad de AEM Forms.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Especifique InputStream que represente el documento PDF del que se van a quitar los derechos de uso<br /> . Puede utilizar LiveCycle Rights Management o documentos protegidos por seguridad de AEM Forms.</td> 
  </tr> 
 </tbody> 
</table>
