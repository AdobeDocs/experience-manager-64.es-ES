---
title: Configuración y configuración de sitios de referencia de AEM Forms
seo-title: Configuración y configuración de sitios de referencia de AEM Forms
...
# Configuración y configuración de sitios de referencia de AEM Forms {#set-up-and-configure-aem-forms-reference-sites}
...
Instale los siguientes paquetes de sitios de referencia mediante el uso compartido de paquetes.
...
1. Vaya a **[!UICONTROL Herramientas > Servicios de nube > Adobe Sign > global]**. Seleccione **[!UICONTROL AEM Forms Reference Site Sign]** y toque **[!UICONTROL Properties]**.
