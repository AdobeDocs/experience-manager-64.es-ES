...
1. **AEM flujo de trabajo:** AEM los flujos de trabajo también se pueden utilizar como procesos posteriores para las cartas enviadas. Instrucciones para configurar [AEM Workflow](/help/forms/using/aem-forms-workflow.md).
...
Para obtener más información sobre cómo guardar un borrador de carta, consulte [Guardar borradores y enviar instancias de carta](/help/forms/using/create-correspondence.md#savingdrafts).
