...
>[!NOTE]
>
>La etiqueta Campo numérico AF no se ha modificado porque ha anulado esta propiedad del cuadro de diálogo de propiedades del componente, tal como se describe en [Agregar contenido al formulario adaptable](#p-add-content-to-adaptive-form-br-p).
