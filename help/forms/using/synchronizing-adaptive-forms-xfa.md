...
Siempre que haya algún cambio en un archivo XDP o un fragmento, la interfaz de usuario de AEM Forms marca todos los formularios adaptables basados en el archivo XDP o el fragmento.
