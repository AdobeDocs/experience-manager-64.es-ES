...
Crear y editar fragmentos de documento de texto para usarlos en comunicaciones interactivas: el texto es uno de los cuatro tipos de fragmentos de documento que se utilizan para crear comunicaciones interactivas. Los otros tres son condiciones, listas y fragmentos de diseño.
...
1. Especifique la siguiente información:
   ...
   * **[!UICONTROL Modelo de datos de formulario]**: de forma opcional, seleccione el botón de radio Modelo de datos de formulario para crear el texto basado en un modelo de datos de formulario. Al seleccionar el botón de radio Modelo de datos de formulario, **[!UICONTROL Modelo de datos de formulario*]** aparece. Busque y seleccione un modelo de datos de formulario. Al crear texto y condiciones para una comunicación interactiva, asegúrese de utilizar el mismo modelo de datos que desea utilizar en la comunicación interactiva. Para obtener información sobre el modelo de datos de formulario, consulte [Integración de datos](/help/forms/using/data-integration.md).
...
1. Escriba el texto y utilice las siguientes opciones para aplicar formato, condicionar e insertar propiedades y variables del modelo de datos de formulario en el texto:
   ...
   * [Buscar y reemplazar texto](#search-features)
