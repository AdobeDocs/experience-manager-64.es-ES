...
1. Haga clic en **[!UICONTROL Adobe Experience Manager]**, en **[!UICONTROL Forms]** y, a continuación, en **[!UICONTROL Temáticas]**.
...
1. Haga clic en **[!UICONTROL Crear]** y, a continuación, haga clic en **[!UICONTROL Editar]** para abrir el tema en el Editor de temas, o haga clic en **[!UICONTROL Hecho]** para volver a la página temáticas.
...
1. En la página Temáticas, haga clic en **[!UICONTROL Crear > Carga]** de archivos.
...
Haga clic en **EXPANDIR TODO** en la barra lateral para aplicar vista, seleccionar y aplicar estilo a los componentes clasificados que no están visibles en primer plano.
...
Cuando se agrega un estilo a la biblioteca de recursos, está disponible para otras temáticas y en el modo [de](/help/forms/using/inline-style-adaptive-forms.md) estilo del editor de formularios o la interfaz de usuario del editor de comunicaciones interactivo. Del mismo modo, cuando se utiliza el modo de estilo del editor de formularios o la interfaz de usuario del editor de comunicaciones interactivo para aplicar estilo a un componente, el estilo se almacena en caché y está disponible en temáticas.
...
El Editor de temas permite editar un tema que haya creado o cargado. Vaya a **[!UICONTROL Forms y Documentos > Temáticas]**, seleccione un tema y ábralo. El tema se abre en el Editor de temas.
...
**Figura:** *Barra de herramientas de componentes del cuadro numérico del Lienzo*
...
1. El título de la barra lateral cambia a Utilidad de cuadro numérico y muestra opciones para personalizar su aspecto.
   ...
   Utilice la opción **[!UICONTROL Dimension y posición]** de la barra lateral para personalizar el tamaño del componente. Asegúrese de que el estado es **[!UICONTROL predeterminado]**.
...
1. En la instancia de autor, haga clic en ![](assets/adobeexperiencemanager.png)**[!UICONTROL adobeexperience emanagerAdobe Experience Manager > Herramientas ]**![martillo](assets/hammer.png)**[!UICONTROL > Implementación > Cloud Services ]**.
1. En la página **[!UICONTROL Cloud Services]** , vaya a Servicios **[!UICONTROL de]** terceros > **[!UICONTROL Typekit]** y haga clic en **[!UICONTROL Configurar ahora]** en Typekit. Si ya hay una configuración disponible, haga clic en el botón **+** para crear una nueva instancia.
...
* **Evitar recursos de otro tema**
   ...
   Al editar un tema, puede examinar y añadir recursos (como imágenes) de otras temáticas. Por ejemplo, está editando el fondo de una página. Por ejemplo, cuando selecciona **[!UICONTROL Página]** , botón ![de](assets/edit-button.png)edición > **[!UICONTROL Fondo > Añadir > Imagen]**, verá un cuadro de diálogo que le permite examinar y agregar imágenes en otro tema.
...
* **Uso de clientlib base, editor de temas y estilo en línea**
   ...
   * **Base clientlib**:
      ...
      1. En la página Temáticas, seleccione un tema y haga clic en Propiedades **[!UICONTROL de la Vista]**.
