...
1. En la ficha General , busque y seleccione un formulario o una comunicación interactiva para la **[!UICONTROL Formulario/documento adaptable]** campo .
...
Ahora puede utilizar fuentes disponibles en un servicio web en un formulario adaptable o una comunicación interactiva. Predeterminado, [Typekit](https://typekit.com/), el servicio de fuentes web de Adobe está disponible como configuración. Para utilizar Typekit, cree un kit y fuentes en él, y obtenga el ID del Kit de [Sitio web de Typekit](https://typekit.com/).
...
1. Apertura **[!UICONTROL Servicio de configuración de tema del formulario adaptable]**.
...
1. Abra la comunicación interactiva en modo de edición. Para abrir una comunicación interactiva en modo de edición, seleccione un formulario y haga clic en **[!UICONTROL Apertura]**.
1. En el modo de edición, seleccione un componente y haga clic en ![nivel de campo](assets/field-level.png) >**[!UICONTROL Contenedor de documento]** y, a continuación, haga clic en ![cmppr](assets/cmppr.png).

   Puede editar las propiedades del formulario en la barra lateral.

1. En la barra lateral, debajo de **[!UICONTROL Básico]**, seleccione el tema en la **[!UICONTROL Tema]** y haga clic en **[!UICONTROL Listo]** ![botón de verificación](assets/check-button.png).
...
* **Uso de clientlib base, editor de temas y estilo en línea**
   ...
   * **Estilo en línea:**
      ...
      Los componentes de estilo se pueden aplicar con el modo Estilo del editor multicanal de comunicación interactiva o de formulario cuando se trabaja con un formulario. Si se utiliza el modo de estilo para cambiar el estilo de los componentes del formulario, se anula el estilo especificado en la temática. Si desea cambiar el estilo de ciertos componentes de un formulario concreto, consulte [Estilo en línea de los componentes](/help/forms/using/inline-style-adaptive-forms.md).
