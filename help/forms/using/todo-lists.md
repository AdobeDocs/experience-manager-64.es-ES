...
* Desde la lista de tareas pendientes, sin abrir la tarea
   ...
   Nota: Esta opción está disponible si el campo `isMustOpenToComplete` no está seleccionado en el paso `Assign Task` de Workbench mientras se diseña un proceso.
