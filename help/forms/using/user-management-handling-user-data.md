...
Los datos de administración de usuarios para los usuarios que al menos una vez accedieron a las aplicaciones de Forms en `https://[*server*]:[*host*]/lc` también se almacenan en AEM repositorio.
