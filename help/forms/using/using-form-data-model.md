...
Puede crear [formularios adaptables](/help/forms/using/creating-adaptive-form.md) y [fragmentos de formulario adaptables](/help/forms/using/adaptive-form-fragments.md) basado en un modelo de datos de formulario. Para utilizar un modelo de datos de formulario al crear un formulario adaptable o un fragmento de formulario adaptable, haga lo siguiente:
...
1. En la pestaña modelo de formulario de la pantalla Agregar propiedades, seleccione **[!UICONTROL Modelo de datos de formulario]** en la lista desplegable **[!UICONTROL Seleccionar desde]**.
   ...
   ![crear-af-1](assets/create-af-1.png)
...
1. Pulse para expandir **[!UICONTROL Seleccionar modelo de datos de formulario]**. Se muestran todos los modelos de datos de formulario disponibles.
   ...
   ![crear-af-2](assets/create-af-2.png)
