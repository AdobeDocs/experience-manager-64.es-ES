...
Continúe leyendo para obtener una introducción rápida a las nuevas funciones y mejoras. Visite la documentación de recursos para obtener detalles. Consulte también AEM 6.4 Forms [notas de la versión](/help/release-notes/forms.md). Para obtener la documentación completa de AEM 6.4 para Forms, visite [AEM 6.4 Forms Guide](/help/forms/home.md).
...
### Creación de comunicación interactiva con varios canales {#multi-channel-interactive-communication-authoring}
...
Para obtener más información, consulte [Información general de comunicaciones interactivas](/help/forms/using/interactive-communications-overview.md).
...
### Generar automáticamente la versión web a partir de contenido impreso en comunicación interactiva {#auto-generate-web-version-from-print-content-in-interactive-communication}
...
Para obtener más información, consulte [Imprimir canal y canal Web](/help/forms/using/web-channel-print-channel.md).

### Utilice temáticas para aplicar estilo al canal web de comunicación interactiva {#use-themes-to-style-web-channel-of-interactive-communication}
...
Para obtener más información, consulte [Creación de un modelo de datos de formulario](/help/forms/using/create-form-data-models.md).
...
Cualquier actualización en propiedades o entidades de origen de datos no se refleja automáticamente en los modelos de datos de formulario asociados. El editor del modelo de datos de formulario ahora presenta ![refresh_forms_di](assets/refresh_forms_di.png) (Actualizar definiciones de fuentes de datos) que invalida la caché del servidor y obtiene el esquema actualizado del origen de datos para que se refleje inmediatamente en el modelo de datos de formulario.

### Configurar orígenes de datos mediante la interfaz de usuario táctil {#configure-data-sources-using-touch-user-interface}
...
### Mejorar el rendimiento de los formularios adaptables con carga diferida mejorada {#improve-performance-of-adaptive-forms-with-enhanced-lazy-loading}
...
La aplicación de AEM Forms permite a los trabajadores de campo sincronizar sus dispositivos móviles con un servidor AEM Forms y trabajar en sus formularios. La aplicación funciona perfectamente cuando el dispositivo está sin conexión, al guardar datos localmente en el dispositivo y sincronizar los datos con el servidor cuando el dispositivo vuelve a estar en línea. Para obtener más información, consulte [Aplicación de AEM Forms](/help/forms/using/aem-forms-app.md).
