...
1. Pulse ![aem_6_3_edit](assets/aem_6_3_edit.png) en el argumento de servicio de lectura para enlazar el argumento a un atributo de perfil de usuario, atributo de solicitud o valor literal y especifique el valor de enlace. Vincula el argumento del servicio al atributo del enlace o el valor literal especificado, el cual se pasa al servicio como argumento para recuperar datos asociados con el valor especificado de la fuente de datos.
