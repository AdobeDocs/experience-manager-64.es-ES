...
1. [Editar propiedades de formulario adaptable para el signo de Adobe](/help/forms/using/working-with-adobe-sign.md#main-pars-header-46741052)
1. [Adición de campos de Adobe Sign a un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header-868561487)
1. [Habilitar Adobe Sign para un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
1. [Seleccione el servicio de Adobe Sign Cloud para un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)

1. [Agregar firmantes de Adobe Sign a un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
1. [Seleccionar acción de envío para un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header)
...
[Crear un formulario adaptable para Adobe Sign](/help/forms/using/working-with-adobe-sign.md#create-an-adaptive-form-for-adobe-sign) describe los pasos para crear un formulario adaptable básico. Consulte [Creación de un formulario](/help/forms/using/creating-adaptive-form.md) adaptable para otras opciones disponibles al crear un formulario adaptable.
...
1. En la ficha **[!UICONTROL Básico]** :
   ...
   1. Seleccione el contenedor [de](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) configuración creado al configurar Adobe Sign con AEM Forms.
...
1. En la ficha **Modo[!UICONTROL de]formulario**l, seleccione una de las siguientes opciones:
...
1. Arrastre y suelte el componente Bloque **de firma de** Adobe desde el navegador de componentes al formulario adaptable. El componente Bloque de Adobe Sign tiene todos los campos de Adobe Sign admitidos. De forma predeterminada, agrega un campo **Signature **al formulario adaptable.
...
1. Seleccione un servicio en la nube de la lista ya configurada de Adobe Sign Cloud Services.
   ...
   Si la lista de servicios **de** Adobe Sign Cloud está vacía, siga el artículo [Configurar Adobe Sign con AEM Forms](/help/forms/using/adobe-sign-integration-adaptive-forms.md) para configurar el servicio.
...
1. [Agregue firmantes a un formulario](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451) adaptable y toque el icono Finalizado para guardar los cambios.
...
Después de [editar las propiedades de formulario adaptable para el signo](/help/forms/using/working-with-adobe-sign.md#main-pars-header-46741052)de Adobe, realice los siguientes pasos para agregar un campo de firma en la nube a un formulario adaptable:
...
1. Toque el icono **Adobe Sign Field** ![aem_6_3_adobesign](assets/aem_6_3_adobesign.png) . Muestra opciones para seleccionar y agregar campos de Adobe Sign.
   ...
   * [Habilitar Adobe Sign para un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
   * [Seleccione el servicio de Adobe Sign Cloud para un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)
   * [Agregar firmantes de Adobe Sign a un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
   * [Seleccionar acción de envío para un formulario adaptable](/help/forms/using/working-with-adobe-sign.md#main-pars-header)
...
1. [Agregue y configure el componente](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)Paso de firma.
1. [Agregue el componente](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)Paso de resumen.
...
**** Ans: Sí, puede utilizar etiquetas de texto en un componente de texto para agregar campos de Adobe Sign a un formulario adaptable [Documento de registro](/help/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md) (solo para la opción de documento de registro generado automáticamente). Para obtener más información sobre el procedimiento y las reglas para crear una etiqueta de texto, consulte la documentación de [Adobe Sign](https://helpx.adobe.com/sign/help/text-tags.html). Además, los formularios adaptables tienen una compatibilidad limitada con las etiquetas de texto. Puede utilizar las etiquetas de texto para crear solo los campos que admite [Adobe Sign Block](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1373840282) .
