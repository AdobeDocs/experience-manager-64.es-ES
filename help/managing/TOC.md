...
+ Administración: referencia adicional {#managing-further-reference}
   + [Pautas para el tamaño del hardware](hardware-sizing-guidelines.md)
   + [Operaciones de desarrollo empresarial ](enterprise-devops.md)
   + [Prácticas recomendadas para la administración de direcciones URL y SEO](seo-and-url-management.md)
