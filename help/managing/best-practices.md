...
* Documentación, basada directamente en la [lista de comprobación](/help/managing/best-practices-checklist.md), que detalla:
   ...
   * [Análisis de ](#project-heartbeat-dashboard) latidos del proyecto.
...
La hoja de cálculo **Estado por función** muestra un desglose detallado de **[estado, calidad y complejidad](#project-heartbeat-dashboard)** por **[fase](#phases-and-milestones)** y **[personal](#persona)**.
...
* [Implementación y mantenimiento de las optimizaciones](/help/sites-deploying/best-practices.md)
...
* Documentación AEM
   ...
   * Conceptos de AEM:
      ...
      * [Lenguaje de plantilla HTML (HTL)](https://helpx.adobe.com/experience-manager/htl/user-guide.html)
