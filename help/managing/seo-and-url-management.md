...
* Cuanto más fácil de leer sea una URL, mejor. Si las palabras clave están presentes en la URL, aumenta su valor.
   ...
   * Por ejemplo: `mybrand.com/products/product-detail.product-category.product-name.html` se prefiere en lugar de `mybrand.com/products/product-detail.1234.html`
