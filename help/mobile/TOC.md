...
audience: end-user
user-guide-title: Guía del usuario de AEM 6.4 Mobile
...
# Guía del usuario de AEM 6.4 Mobile {#mobile}

+ [Información general sobre la Guía del usuario móvil](home.md)
...
+ Creación de la aplicación de servicios bajo demanda {#authoring}
   ...
   + [Panel de aplicaciones móviles de AEM](mobile-apps-ondemand-application-dashboard.md)
   + [Acciones de creación y configuración de aplicaciones](mobile-apps-ondemand-application-create-configure-action.md)
   + [Administración de artículos](mobile-on-demand-managing-articles.md)
...
+ Desarrollo de la aplicación de servicios bajo demanda {#developing}
   ...
   + [Uso de las propiedades de contenido para exportar contenido](on-demand-content-properties-exporting.md)
...
+ Administración de la aplicación de servicios bajo demanda {#administering}
   ...
   + [Vista previa con comprobación preliminar](aem-mobile-manage-ondemand-services.md)
   + [Aplicaciones móviles](administer-mobile-apps.md)
   + [Información general sobre modelos](model-management.md)
   + [Espacios y entidades](spaces-and-entities.md)
   + [Administración de colecciones](mobile-on-demand-managing-collections.md)
+ Creación de Adobe PhoneGap Enterprise {#author-phonegap}
   + [PhoneGap](phonegap.md)
   + [Edición de metadatos de aplicaciones](phonegap-editmetadata.md)
   + [Definiciones de aplicaciones](phonegap-app-definitions.md)
   + [Creación y administración del contenido de la aplicación](phonegap-manage-app-content.md)
   + [Creación de una nueva aplicación de AEM Mobile mediante el asistente de creación](phonegap-create-new-app.md)
   + [Creación de aplicaciones móviles](phonegap-authoring-apps.md)
   + [Administrar mosaico de aplicación](phonegap-app-details-tile.md)
   + [Personalización del contenido de AEM Mobile](phonegap-aem-mobile-content-personalization.md)
+ Desarrollo de Adobe PhoneGap Enterprise {#developphonegap}
   + [PhoneGap](developing-in-phonegap.md)
   + [Creación de aplicaciones móviles](building-app-mobile-phonegap.md)
   + [Notificaciones push](phonegap-push-notifications.md)
   + [Desarrollo de aplicaciones móviles en AEM](developing-mobile-applications.md)
   + [Móvil con sincronización de contenido](phonegap-contentsync.md)
   + [La anatomía de una aplicación](phonegap-apps-arch.md)
   + [Desarrollo de aplicaciones con la CLI de PhoneGap](phonegap-apps-pg-cli.md)
   + [Controladores de aplicación predeterminados](contentsync-app-handlers.md)
   + [Creación y edición de aplicaciones mediante la consola Aplicaciones](phonegap-apps-console.md)
   + [¿Su aplicación híbrida está lista para AEM Mobile?](phonegap-adding-content-to-imported-app.md)
   + [Acceder a las funciones de los dispositivos](phonegap-access-device-features.md)
   + [Añadir Adobe Analytics a la aplicación móvil](phonegap-add-analytics-to-apps.md)
   + [Plantillas de página para aplicaciones móviles](phonegap-apps-arch-page-templates.md)
   + [Configuración del servicio en la nube de Adobe Target](aem-mobile-configuring-cloud-service.md)
   + [Aplicaciones de una sola página](phonegap-single-page-applications.md)
   + [Modelos en el repositorio](https://experienceleague.adobe.com/docs/experience-manager-64/mobile/administering/administer-mobile-apps.html)
   + [Inicio de PhoneGap de AEM](starting-aem-phonegap-app.md)
   + [Prueba de aplicaciones móviles](develop-mobile-apps-testing.md)
   + [Estructura de una aplicación](phonegap-structure-an-app.md)
   + [Seguimiento del rendimiento de las aplicaciones con Adobe Mobile Analytics](phonegap-intro-to-app-analytics.md)
+ Administración de Adobe PhoneGap Enterprise {#administering-phonegap}
   ...
   + [Configurar el servicio en la nube de Adobe Mobile Services](configure-adobe-mobile-cloud-service.md)
