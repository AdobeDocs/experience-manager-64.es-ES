...
+ Creación de la aplicación de servicios bajo demanda {#authoring}
   ...
   + [Panel de aplicaciones de AEM Mobile](mobile-apps-ondemand-application-dashboard.md)
...
+ Creación de Adobe PhoneGap Enterprise {#author-phonegap}
   ...
   + [Personalización de contenido de AEM Mobile](phonegap-aem-mobile-content-personalization.md)
+ Desarrollo de Adobe PhoneGap Enterprise {#developphonegap}
   ...
   + [Inicio AEM PhoneGap](starting-aem-phonegap-app.md)
   + [Prueba de aplicaciones móviles](develop-mobile-apps-testing.md)
   + [Estructura de una aplicación](phonegap-structure-an-app.md)
   + [Seguimiento del rendimiento de la aplicación con Adobe Mobile Analytics](phonegap-intro-to-app-analytics.md)
+ Administración de Adobe PhoneGap Enterprise {#administering-phonegap}
   ...
   + [Configurar su Cloud Service de Adobe PhoneGap Build](configure-phonegap-build-cloud.md)
   + [Configuración del filtro de referente para permitir que esté vacío](setting-referrer-filter-empty.md)
   + [Configurar el Cloud Service de Adobe Mobile Services](configure-adobe-mobile-cloud-service.md)
