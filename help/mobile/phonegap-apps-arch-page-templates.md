...
Como se describe en [AEM plantillas](/help/mobile/apps-architecture.md)de página, cada componente puede generar un fragmento de JavaScript para consumir el contenido JSON expuesto por la `data` promesa. Siguiendo convenciones angulares, un controlador solo debe utilizarse para asignar variables al ámbito.
