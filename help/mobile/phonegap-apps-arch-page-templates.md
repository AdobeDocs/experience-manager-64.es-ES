...
Como se describe en Plantillas [de página de](/help/mobile/apps-architecture.md)AEM, cada componente puede generar un fragmento de JavaScript para consumir el contenido JSON expuesto por la `data` promesa. Siguiendo convenciones angulares, un controlador solo debe utilizarse para asignar variables al ámbito.
