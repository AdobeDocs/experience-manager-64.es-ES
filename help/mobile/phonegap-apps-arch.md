...
Una vez que haya aprendido sobre la Anatomía de una aplicación, consulte [Aplicaciones de una sola página](/help/mobile/phonegap-single-page-applications.md).
