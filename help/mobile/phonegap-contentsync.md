...
>[!NOTE]
>
>Para obtener más información sobre las directrices para el desarrollo de controladores de sincronización de contenido, consulte los controladores de aplicaciones predeterminados en [Desarrollo de controladores de sincronización de contenido](/help/mobile/contentsync-app-handlers.md).
...
**** contentRepresentar contenido mediante el procesamiento de solicitudes estándar de Sling.
