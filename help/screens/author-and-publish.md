...
### Configuración de agentes de replicación en el autor {#setting-up-replication-agents-on-author}

Para crear agentes de replicación, debe aprender a crear un agente de replicación estándar.

Se necesitan 3 agentes de replicación para las pantallas:
...
Siga los mismos pasos para crear un agente de replicación inversa.
...
1. Vaya a https://&lt;host>:&lt;puerto>/system/console/configMgr
1. Seleccione **Apache Sling Oak-Based Discovery Service** Configuration.
1. Actualizar direcciones URL del conector de topología: agregue direcciones URL de todas las instancias de publicación de participación, es decir, [http://localhost:4502/libs/sling/topology/connector](http://localhost:4502/libs/sling/topology/connector)
...
Para cualquiera de las instancias de Publish, navegue a https://&lt;host>:&lt;puerto>/system/console/topología. Debe ver cada instancia de publicación representada en la topología.
...
1. Vaya a la Consola OSGi -> Principal > Artemis ActiveMQ ([http://localhost:4505/system/console/mq](http://localhost:4505/system/console/mq)).
...
1. Vaya a **Configuration Manager** desde la consola **OSGi**.
1. Seleccione **Apache Sling Referrer Filter (Filtro** de referente de Sling de Apache).
1. Actualice la configuración y **marque Permitir vacío**.
...
1. Vaya a [http://localhost:4502/screens.html/content/screens/we-retail](http://localhost:4502/screens.html/content/screens/we-retail) o seleccione el proyecto y vaya a Dispositivos > Administrador de dispositivos.
...
1. Vaya a la página de administración del usuario (p. ej.: [http://localhost:4502/useradmin](http://localhost:4502/useradmin)).
...
1. Haga clic en la opción **Configuración **desde el panel lateral.
...
1. Haga clic en **Publicar** en el **Asistente **de gestión de** publicaciones.
...
1. Haga clic en **Publicar **desde el asistente Administrar** publicación **.**
