...
1. En [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp) (o IDE de su elección) debajo de para `/apps/weretail-run/components/content`crear un nuevo `cq:Component` nombre `poster`.
