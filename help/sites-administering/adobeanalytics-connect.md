...
>[!CAUTION]
>
>Proporcionar privilegios de **administrador** (dentro de Adobe Analytics) no es suficiente para permitir que un usuario se conecte de AEM a Adobe Analytics. La cuenta también debe tener privilegios de acceso **a servicios** Web.
...
Utilice la consola [web para configurar el](/help/sites-deploying/configuring-osgi.md#osgi-configuration-with-the-web-console) Adobe del paquete **OSGi AEM el cliente** HTTP de Analytics. Añada la dirección URL **del centro de** datos para el centro de datos que aloja un grupo de informes para el cual las páginas AEM recopilan datos.
...
1. Seleccione el elemento Configuración denominado **Adobe AEM cliente** HTTP de Analytics.
...
## Creación de un Adobe Analytics Framework {#creating-a-adobe-analytics-framework}
...
>
>Por ejemplo, un marco de trabajo está configurado para utilizar el grupo de informes *digital* y el autor es la instancia de servidor seleccionada. Cuando las páginas se publican junto con la estructura, se siguen realizando llamadas a Adobe Analytics, aunque estas llamadas no contienen el RSID. Sólo las llamadas de la instancia de autor incluyen el RSID.

1. Con **Navegación**, seleccione **Herramientas**, **Cloud Services** y, a continuación, Cloud Services **** preexistentes.
2. Desplácese a **Adobe Analytics** y haga clic en **[+]** junto a Configuraciones **** disponibles.
3. Haga clic en el vínculo **[+]** al lado de la configuración de Adobe Analytics.
...
* **Servidor de seguimiento**
   ...
   * contiene la dirección URL utilizada para enviar llamadas de Adobe Analytics
      ...
      * cname: el valor predeterminado es *nombre de Compañía * de la cuenta de Adobe Analytics
...
Consulte [Visualización de datos](/help/sites-authoring/pa-using.md) de análisis de página para obtener más información.

### Configuración del intervalo de importación {#configuring-the-import-interval}

Configure la instancia adecuada del servicio **Adobe AEM configuración** de encuestas administradas:
...
Al igual que al crear una configuración o un marco de trabajo de Adobe Analytics, navegue a la pantalla (heredada) de **Cloud Services** . Seleccione **Mostrar configuraciones** y, a continuación, haga clic en el vínculo a la configuración específica que desee actualizar.
