...
Oak expone un conjunto de elementos de configuración del analizador de lucene que se utilizan en AEM. Para obtener información sobre cómo utilizar los filtros, consulte **Apache Oak Analyzers** en la guía [de implementación de búsquedas](https://helpx.adobe.com/experience-manager/kt/sites/using/search-tutorial-develop.html)simples.
...
### ¿Cómo configurar las perspectivas de recursos con la instancia de AEM 6.4? {#how-to-configure-asset-insights-with-aem-instance}
...
AEM proporciona varios mecanismos que le permiten personalizar las consolas y la funcionalidad de creación de páginas de su instancia de creación.
...
### Si un cliente compra solo la licencia de Sitios en AEM, ¿aún tiene acceso a Recursos? {#if-a-customer-buys-only-sites-license-in-aem-do-they-still-have-access-to-assets}
...
* [Software local de Adobe Experience Manager](https://helpx.adobe.com/legal/product-descriptions/adobe-experience-manager-on-premise.html)

* [Servicios gestionados de Adobe Experience Manager](https://helpx.adobe.com/legal/product-descriptions/adobe-experience-manager-managed-services.html)
