...
### Inicio para crear su campaña {#start-building-your-campaign}
...
* Personalización con los campos de personalización del componente **Texto y personalización**

**En Adobe Campaign**

* Crear un envío de tipo **aemContent**
...
Debe instalar el paquete **AEM Integration** en Adobe Campaign. Para ello:
...
1. Haga clic en **Siguiente** y, a continuación, en **Inicio**.
   ...
   >
   >Recomendamos encarecidamente crear una zona de seguridad dedicada a AEM para evitar cualquier problema de seguridad. Para obtener más información sobre esto, consulte la guía [Instalación](https://docs.campaign.adobe.com/doc/AC/en/INS_Additional_configurations_Configuring_Campaign_server.html).
...
>[!NOTE]
>
>Si no desea utilizar la URL de replicación, sino la URL pública, puede establecer la URL **** pública en la siguiente configuración en OSGi (**AEM logotipo** > icono **Herramientas** > **Operaciones** > Consola **** web > ConfiguraciónOSGi > Integración de configuraciónAEM configuración - Campaña de configuración **** ****):
...
1. En la instancia de creación, seleccione **AEM logotipo**> **Herramientas** > **Implementación** > **Replicación** > **Agentes en el autor****** y, a continuación, haga clic en Agente predeterminado.
...
1. Seleccione **AEM logotipo** > **Herramientas** > **Implementación** > **Cloud Services** y, a continuación, **Configurar ahora** en la sección Adobe Campaign.
...
Para agregar un nuevo campo de personalización a los que ya están disponibles, debe extender el esquema **nms:semillaMember** de Adobe Campaign de la siguiente manera:
...
1. Introduzca los distintos parámetros del esquema extendido:
   ...
   * **Esquema**: seleccione el esquema **nms:startingMember** . Los demás campos de la ventana se completan automáticamente.
...
Para ocultar un campo de personalización entre los que ya están disponibles, debe ampliar el esquema **nms:semillaMember** de Adobe Campaign, tal como se detalla en la sección [Añadir un campo](#adding-a-personalization-field) de personalización. Siga estos pasos:
...
1. Vaya al nodo **Recursos** > **Gestión de la campaña** > **Bloques de personalización** en la navegación de Adobe Campaign.
...
>[!NOTE]
Los datos del destinatario solo están disponibles si el contenido AEM está sincronizado con un envío de Adobe Campaign. See [Synchronizing content created in AEM with a delivery from Adobe Campaign](/help/sites-authoring/campaign.md#synchronizing-content-created-in-aem-with-a-delivery-from-adobe-campaign-classic).
