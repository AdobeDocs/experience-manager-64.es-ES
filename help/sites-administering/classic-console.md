...
En general, el idioma de la etiqueta se toma del idioma de la página si el idioma de la página está disponible. Cuando el widget de [](/help/sites-developing/building.md#tagging-on-the-client-side)etiqueta se usa en otros casos (por ejemplo en formularios o en cuadros de diálogo), el idioma de etiqueta depende del contexto.
