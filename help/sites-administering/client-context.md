...
* **Editar** Se abrirá una nueva página que le permitirá [editar, agregar o quitar una propiedad](#editing-property-details)de perfil.
...
**Carro** de compras Muestra la información del carro de compras, incluso las entradas de productos (título, cantidad, precioFormateado, etc.), las promociones resueltas (título, mensaje, etc.) y vales (código, descripción, etc.).
