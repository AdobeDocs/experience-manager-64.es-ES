...
>[!NOTE]
>
>Tenga en cuenta la diferencia entre `getEffectivePolicies` y el ejemplo de código subsiguiente que sube por la jerarquía para averiguar si una ruta dada ya forma parte de un CUG existente.
...
Pasos para eliminar un requisito de autenticación existente. El requisito solo se anulará del registro del autenticador de Apache Sling si se ha configurado el `RequirementHandler` para el árbol que contiene el nodo de destinatario.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    </ul> <p>Consulte también <a href="/help/sites-administering/closed-user-groups.md#configuration-options" target="_blank">Opciones de configuración</a> a continuación.</p> </td> 
  </tr> 
  <tr> 
...
1. Introduzca la ruta raíz que desea buscar en los CUG y pulse el botón **Realizar ejecución en seco**. Esto analizará los CUG aptos para la conversión en la ubicación seleccionada.
