...
* Varios componentes **de AEM** listos para usar para ilustrar lo que se puede lograr con el proyecto:
...
* Utiliza la capacidad AEM para **presentar el contenido en varios canales**, ya sea en la ventana completa del navegador o en el dispositivo móvil. Esto ofrece el contenido en el formato que necesitan sus visitantes.
...
La sección [Conceptos](/help/sites-administering/concepts.md) cubre el marco de trabajo con más detalle, pero a continuación se proporciona una vista de alto nivel y alta velocidad del mismo:
