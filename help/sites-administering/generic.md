...
1. Cambie al modo [previsualización](/help/sites-authoring/editing-content.md#previewing-pages).
...
>[!NOTE]
>
>El catálogo hará referencia a los [datos del producto](#editing-product-information).
...
>[!NOTE]
>
>El siguiente ejemplo trata de una promoción que se realiza directamente en una [campaña](/help/sites-authoring/personalization.md), que se utiliza para los comprobantes.
>
