...
Se puede utilizar un formulario para recopilar la información de registro y, a continuación, generar la cuenta y el perfil nuevos.

Por ejemplo, los usuarios pueden solicitar un nuevo perfil mediante la página Geometrixx\
