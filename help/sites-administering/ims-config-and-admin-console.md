...
description: Obtenga información sobre cómo utilizar Admin Console en AEM.
seo-description: Obtenga información sobre cómo utilizar Admin Console en AEM.
...
Los usuarios y grupos se pueden crear manualmente en la interfaz de usuario de Admin Console. Este método se puede utilizar si no tienen un gran número de usuarios que administrar. Por ejemplo, un número de menos de 50 usuarios de AEM.
