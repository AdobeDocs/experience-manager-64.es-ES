...
1. Indique si desea sincronizar la página después de revertir la herencia y, a continuación, confirme la acción **Reanudar** en el cuadro de diálogo **Reanudar Live Copy **1.
...
1. Abra las propiedades de la página de Live Copy con la opción **Propiedades de Vista** de la consola **Sitios** o con el icono **Información de página** de la barra de herramientas de la página.
