...
1. La tarea **Limpieza de revisión **tarea, ubicada en el menú Ventana **de mantenimiento** diario.
...
Una vez implementado el servicio, se expondrá a la interfaz de usuario del panel de operaciones y se podrá agregar a una de las programaciones de mantenimiento disponibles:
