...
1. Cree una nueva configuración presionando el botón &quot;+&quot; en el lado derecho de la configuración. Aparecerá una nueva ventana, como se muestra a continuación:
   ...
   ![imagen_1-63](assets/chlimage_1-63.jpeg)
...
Al hacer clic en el botón **Incluir tiempo de ejecución** antes de ejecutar la consulta también mostrará la cantidad de tiempo en que se ejecutó la consulta, lo que permite obtener más información que se puede utilizar para optimizar los índices de su aplicación o implementación.
...
1. La tarea **Limpieza de revisión **ubicada en la sección **Ventana de mantenimiento diario** para abrir el Navegador.

1. La tarea **Limpieza de binarios de Lucene **se encuentra en la sección **Ventana de mantenimiento diario** para abrir el Navegador.

1. La tarea **Workflow purge **ubicada en la sección **Período de mantenimiento semanal** para abrir el Navegador.
...
Para obtener más información sobre la realización de la limpieza de revisión para AEM 6.4, [consulte este artículo específico](/help/sites-deploying/revision-cleanup.md).
...
Una vez implementado el servicio, se expone a la interfaz de usuario del panel de operaciones y se puede agregar a uno de los programas de mantenimiento disponibles:
