...
1. La tarea **Limpieza de binarios de Lucene **se encuentra en el menú **Ventana de mantenimiento diario**.
...
Para obtener más información sobre cómo realizar la limpieza de revisión para AEM 6.4, [consulte este artículo dedicado](/help/sites-deploying/revision-cleanup.md).
