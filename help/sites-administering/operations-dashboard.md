...
1. La tarea **Revision Clean Up **situada en el menú **Ventana de mantenimiento diario**.
...
Para obtener más información sobre cómo realizar Revision Clean Up para AEM 6.4, [consulte este artículo dedicado](/help/sites-deploying/revision-cleanup.md).
