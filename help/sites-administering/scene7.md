...
1. Toque el icono [!UICONTROL Herramientas] y luego navegue a **[!UICONTROL Operaciones > Consola Web]**. Se abre la consola Web.
...
1. Vuelva a la página de bienvenida de AEM y toque **[!UICONTROL Flujos de trabajo]**. Haga clic con el doble en el flujo de trabajo **Recurso de actualización de DAM** para abrirlo.
...
* Compruebe que el recurso que está intentando cargar se encuentra en la carpeta **[!UICONTROL destinatario de CQ]** (especifique esta carpeta en la configuración de nube de Dynamic Media Classic).
