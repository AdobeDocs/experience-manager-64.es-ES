...
1. Compruebe la configuración de los procesadores predeterminados, que puede ser un área problemática.
   ...
   * En particular, el procesador JSON que puede invertir la estructura de árbol en varios niveles.
      ...
      **Resultados**  máximos de JSON(  `json.maximumresults`)
      ...
      en la configuración para el [Servlet de GET Apache Sling](/help/sites-deploying/osgi-configuration-settings.md). Cuando se supera este límite, el procesamiento se contraerá. El valor predeterminado para Sling dentro de AEM es `200`.
...
Dado que AEM no proporciona índices predeterminados para `FormChooserServlet`, el uso de selectores de formularios en consultas desencadenará una costosa inversión del repositorio, que generalmente interrumpe la instancia de AEM. Los selectores de formulario se pueden detectar con la presencia del **&amp;ast;.form.&amp;ast;** cadena en consultas.
...
1. Para abrir el CRXDE Lite, vaya a *https://&lt;serrveraddress>:4502/crx/de/index.jsp*
