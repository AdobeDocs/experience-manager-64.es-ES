...
La interfaz de usuario de AEM tiene capacidad táctil. Una interfaz con capacidad táctil le permite utilizar el tacto para interactuar con el software mediante gestos como pulsar, pulsar y mantener o deslizar el dedo. Este funcionamiento contrasta con el de una interfaz de escritorio tradicional, con acciones de ratón como clic, doble clic, clic con el botón secundario o pasar el puntero. Como solo se requieren gestos, la IU con capacidad táctil es plenamente operativa en dispositivos tablet móviles y conserva además toda su funcionalidad en equipos de escritorio.

### Primeros pasos {#first-steps}

Inmediatamente después del inicio de sesión llega al [panel Navegación](/help/sites-authoring/basic-handling.md#global-navigation). Esto se tratará con más detalle en una sección posterior.
...
* [Vistas](/help/sites-authoring/basic-handling.md#viewing-and-selecting-resources)
   ...
   Puede cambiar entre la vista de columna, la vista de tarjeta, la vista de lista y los ajustes de visualización.
...
Puede anular la selección de todos los elementos y salir del modo de selección pulsando o haciendo clic en la X que hay junto al recuento.
...
* Puede ver Datos de Analytics si muestra las columnas apropiadas en el cuadro de diálogo Ajustes de visualización.

   Puede filtrar Datos de Analytics para los últimos 30, 90 o 365 días mediante las opciones de filtro que hay a la derecha del encabezado.
...
* Determinadas consolas tienen funciones adicionales. Por ejemplo, en la consola Sitios puede:
   ...
   * [Guardar una versión](/help/sites-authoring/working-with-page-versions.md).
...
La sección **Referencias** muestra cualquier conexión con el recurso seleccionado. Por ejemplo, en la consola **Sitios**, [Referencias](/help/sites-authoring/author-environment-tools.md#references) muestra lo siguiente para páginas:
...
* Referencias de contenido (por ejemplo, contenido que haya pedido prestado el componente Referencia o que este haya prestado)
