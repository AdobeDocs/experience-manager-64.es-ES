...
1. Toque o haga clic en el botón **Estilos** de la barra de herramientas del componente **Lista** para abrir el menú Estilo y cambiar el aspecto del componente.
   ...
   >[!NOTE]
   >
   >En este ejemplo, los estilos de **Diseño** (**Bloque** y **Cuadrícula**) se excluyen mutuamente, mientras que las opciones de **Pantalla** (**Imagen** o **Fecha**) se pueden combinar. Esto se puede [configurar en la plantilla como el autor de la misma](/help/sites-authoring/style-system.md#as-a-template-author).
