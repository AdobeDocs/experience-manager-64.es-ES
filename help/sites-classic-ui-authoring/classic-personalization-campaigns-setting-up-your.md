...
1. Especifique la dirección, si es necesario. Haga clic en **Guardar** para guardar el posible cliente. Si necesita agregar leads adicionales, haga clic en** Guardar y nuevo**.
...
1. En el menú **Herramientas**, seleccione **Añadir a lista...** Se abre la ventana **Agregar a la lista **se.
