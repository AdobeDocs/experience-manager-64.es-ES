...
**3. Velocidad** de descarga Un problema de rendimiento se produce cuando la descarga desde AEM DAM tarda mucho y las miniaturas no se muestran inmediatamente al explorar DAM Admin o DAM Finder.
