...
Para obtener más información sobre Cloud Manager y sus recursos, consulte la [**Guía del usuario del Administrador de nube**](https://helpx.adobe.com/experience-manager/cloud-manager/user-guide.html).
...
* **cq-quickstart-6.4.0.jar:** un archivo de  ** jerga ejecutable independiente que incluye todo lo necesario para ponerse en marcha.

* **cq-quickstart-6.4.0.war:** Un  ** archivo de almacenamiento para la implementación en un servidor de aplicaciones de terceros.
...
1. Para inicio de la instancia en un entorno GUI, haga clic con el botón doble en el archivo **`cq-quickstart-6.4.0.jar`**.
