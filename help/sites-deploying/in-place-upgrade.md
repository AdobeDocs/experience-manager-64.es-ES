...
Compruebe los archivos de configuración debajo de la `crx-quickstart/install` carpeta. Si fuera necesaria una migración, se actualizarán para reflejar el repositorio de destinatario.
