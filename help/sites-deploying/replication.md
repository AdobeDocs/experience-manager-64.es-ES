...
El sitio web Geometrixx que se incluye en una instalación estándar de AEM puede utilizarse para ilustrar la replicación.
...
>[!NOTE]
>
>Esto se puede combinar con el uso del ID [de usuario del](#settings) agente para seleccionar diferente contenido para replicarlo en los entornos de publicación individuales. Para cada entorno de publicación:
>
