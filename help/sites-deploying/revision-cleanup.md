...
AEM 6.4 también introduce un mecanismo de desduplicación de contenido más eficaz durante la compactación, lo que reduce aún más el espacio en disco del repositorio.

Los dos gráficos que figuran a continuación presentan los resultados de las pruebas internas de laboratorio que ilustran la reducción de los tiempos de ejecución promedio y del espacio medio en disco en AEM 6.4 en comparación con AEM 6.3:
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>El formato de persistencia de TarMK cambiará con AEM 6.4. Estos cambios no requieren un paso de migración proactiva. Los repositorios existentes pasarán por una migración continua, que es transparente para el usuario. El proceso de migración se inicia la primera vez que AEM 6.4 (o herramientas relacionadas) accede al repositorio.</p> <p><strong>Una vez iniciada la migración al formato de persistencia de AEM 6.4, el repositorio no puede volver al formato de persistencia anterior de AEM 6.3.</strong></p> </td> 
  </tr> 
 </tbody> 
</table>
