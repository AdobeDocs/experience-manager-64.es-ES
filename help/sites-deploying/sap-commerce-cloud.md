...
La extensión híbris del eCommerce Integration Framework se ha actualizado para admitir Hybris 5 (como predeterminado), manteniendo al mismo tiempo la compatibilidad con [Hybris 4](/help/sites-developing/sap-commerce-cloud.md#developing-for-hybris).
...
>[!NOTE]
>
>Para los desarrolladores [documentación de API](/help/sites-developing/ecommerce.md#api-documentation) también está disponible para su descarga.
