...
>[!NOTE]
>
>Si también utiliza la variable [Dispatcher](https://helpx.adobe.com/es/experience-manager/dispatcher/using/dispatcher.html) con el servidor de información de Internet (IIS) de Microsoft, se necesitará una configuración adicional en:
>
>* `disp_iis.ini`
>* IIS
>
