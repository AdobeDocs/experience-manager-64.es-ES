...
>
>Para ello, vaya a *http://localhost:4502/system/console/status-slingsettings* y compruebe la línea **&quot;Run Modes&quot;**.
...
1. Para detener el proceso de sincronización en la instancia de espera en frío, vaya a la consola JMX y utilice el archivo **org.apache.jackrabbit.oak: Estado (&quot;Modo de espera&quot;)**. Para obtener más información sobre cómo hacerlo, consulte la sección sobre [Monitorización](#monitoring).
