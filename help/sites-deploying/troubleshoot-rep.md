...
1. Es posible que un determinado fragmento de contenido no se pueda serializar en /var/Replication/data debido a daños en el repositorio o a algún otro problema. Consulte logs/error.log para ver si hay algún error relacionado. Para borrar el elemento de replicación incorrecto, haga lo siguiente:
   ...
   1. En la ventana &quot;Explorador de contenido&quot; haga clic en el botón de la lupa en la parte superior derecha de la ventana y aparecerá un cuadro de diálogo de búsqueda.
   1. Seleccione el botón de opción &quot;XPath&quot;.
   1. En el cuadro &quot;Consulta&quot;, introduzca el orden de consulta /jcr:root/var/eventing/Jobs//element(&amp;ast;,slingevent:Job) de @slingevent:created
...
1. Podría haber algún problema con la venta de colas de trabajos de marco de eventos. Intente reiniciar el paquete org.apache.sling.event en la consola/system/console.
1. Es posible que el procesamiento de trabajos esté completamente desactivado. Puede comprobarlo en la consola Félix, en la ficha Evento de sling. Compruebe si se muestra - Acontecimiento de Apache Sling (EL PROCESAMIENTO DE TRABAJO ESTÁ DESHABILITADO)
...
1. Si sospecha que el problema está relacionado con la venta de eventos/trabajos de cualquier manera, también puede agregar este paquete java en categorías:org.apache.sling.event
