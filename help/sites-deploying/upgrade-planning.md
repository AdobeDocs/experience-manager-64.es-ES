...
Es importante asegurarse de que está ejecutando un sistema operativo compatible, Java runtime, httpd y Dispatcher version. Para obtener más información, consulte la [AEM página Requisitos técnicos de 6.4](/help/sites-deploying/technical-requirements.md). La actualización de estos componentes debe incluirse en el plan del proyecto y realizarse antes de actualizar el AEM.
...
Revise los requisitos técnicos de AEM 6.4 y asegúrese de que su hardware y software actuales sean suficientes. Para ver los posibles cambios en los procesos operativos, consulte los siguientes documentos:
