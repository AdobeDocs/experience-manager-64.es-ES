...
1. Crear nuevas instancias de autor de 6.3, conectadas a la instancia de Mongo actualizada
...
### Si no tiene éxito (Rollback) {#if-unsuccessful}
...
### Si no tiene éxito (Rollback) {#rollback}
