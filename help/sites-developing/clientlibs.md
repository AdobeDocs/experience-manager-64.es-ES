...
1. Abra el CRXDE Lite en un navegador web ([http://localhost:4502/crx/de](http://localhost:4502/crx/de)).
...
Para obtener información sobre la configuración del servicio, consulte [Administrador de biblioteca HTML](/help/sites-deploying/osgi-configuration-settings.md) AEM.
