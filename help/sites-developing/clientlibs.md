...
Para obtener información sobre la configuración del servicio, consulte [AEM Administrador](/help/sites-deploying/osgi-configuration-settings.md)de bibliotecas HTML.
