...
* ¿Qué aspectos de seguridad debo tener en cuenta?
   ...
   * Consulte Lista de comprobación [de seguridad: prácticas](/help/sites-administering/security-checklist.md#development-best-practices) recomendadas de desarrollo para obtener más información.
...
* **IU táctil**
   [La interfaz](/help/sites-developing/touch-ui-concepts.md) de usuario estándar que se introdujo en AEM 5.6.0 como previsualización y se amplió en 6.x. Se basa en la experiencia de usuario unificada del Adobe Marketing Cloud, que utiliza las tecnologías subyacentes de la IU [de](/help/sites-developing/touch-ui-concepts.md#coral-ui) Coral y la IU de [Granite](/help/sites-developing/touch-ui-concepts.md#granite-ui).
...
>[!NOTE]
>
>Adobe recomienda aprovechar la IU táctil para beneficiarse de la tecnología más reciente. [AEM Herramientas de moderación&amp;(moderniatzion-tools.md) puede facilitar la migración.
...
Esta filosofía está respaldada por [HTL](https://helpx.adobe.com/experience-manager/htl/user-guide.html), un lenguaje de plantilla que se limita a propósito para garantizar que se utilice un lenguaje de programación real para definir la lógica comercial subyacente. Esta lógica (opcional) se invoca desde HTL con un comando específico. Este mecanismo resalta el código que se llama para una vista determinada y, si es necesario, permite una lógica específica para distintas vistas del mismo componente.

### HTL vs JSP {#htl-vs-jsp}

HTL es un lenguaje de plantilla HTML introducido con AEM 6.0.

El análisis de si se debe utilizar [HTL](https://helpx.adobe.com/experience-manager/htl/user-guide.html) o JSP (Java Server Pages) al desarrollar sus propios componentes debe ser sencillo, ya que HTL es ahora el lenguaje de secuencias de comandos recomendado para AEM.
...
### Desplazamiento de componentes a la instancia de publicación {#moving-components-to-the-publish-instance}
...
* **Propiedades** vitales:
   ...
   * IU táctil
      ...
      * Consulte la sección Icono [del componente en la IU](/help/sites-developing/components-basics.md#component-icon-in-touch-ui) táctil para obtener más información.
...
1. `cq:icon` - Propiedad de cadena que apunta a un icono estándar en la biblioteca [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/coral-ui/coralui3/Coral.Icon.html) Coral UI para mostrarse en el navegador de componentes
...
La consola [](/help/sites-authoring/default-components-console.md#component-details) Componente muestra cómo se define el icono de un componente concreto.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><code>String</code></td> 
   <td>Si se establece, esta propiedad se toma como ID de celda. Para obtener más información, consulte el artículo de la Base de conocimiento <a href="https://helpx.adobe.com/experience-manager/kb/DesigneCellId.html">Cómo se crean</a>los ID de las celdas de diseño.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Archivo de secuencia de comandos.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Muestra el valor de texto estático &lt;texto&gt;<br /> Solo visible en la IU clásica. La IU táctil no muestra acciones en un menú contextual, por lo que esto no es aplicable.</td> 
  </tr> 
  <tr> 
   <td>-</td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><code>auto</code></td> 
   <td>Si el ancho del componente es menor que el valor del lado del cliente, el cuadro de diálogo está flotando; de lo contrario, está en línea. <code>CQ.themes.wcm.EditBase.INLINE_MINIMUM_WIDTH</code></td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>(<code>boolean</code>) True para activar la edición in situ del componente.</td> 
  </tr> 
  <tr> 
