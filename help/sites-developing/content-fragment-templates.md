...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Título de la plantilla (se muestra en el asistente <strong>Crear fragmento</strong> ).</td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Define una variación inicial.<br /> De forma predeterminada, la variación se agrega a todos los elementos del fragmento de contenido.</p> <p>La variación tendrá el mismo contenido inicial que el elemento respectivo (consulte <code class="code">defaultContent/
