...
| ContextHub.Constants.EVENT_ALL_STORES_READY | Indica que todos los almacenes requeridos están registrados, inicializados y listos para ser consumidos | todo-tiendas-listo |
...
### Constantes de Evento de la interfaz de usuario {#ui-event-constants}
