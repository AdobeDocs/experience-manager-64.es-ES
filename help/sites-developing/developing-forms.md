...
Todos estos componentes se realizan con una serie de [componentes de formulario](/help/sites-authoring/default-components.md) predeterminados, disponibles en una instalación de AEM estándar.
