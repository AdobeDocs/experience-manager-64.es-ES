...
1. Este paso es opcional: establecer las propiedades del componente **Is Container, No Decoration**, **Nombre de celda** y **Ruta de diálogo**. Haga clic en **Siguiente**.
...
Con el CRXDE Lite puede importar o exportar definiciones de tipo de nodo en [Anotación CND (espacio de nombres compacto y definición de tipo de nodo)](http://jackrabbit.apache.org/jcr/node-type-notation.html).
