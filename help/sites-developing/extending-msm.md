...
* **`Blueprint`** Un `Blueprint` (como en la configuración [de](/help/sites-administering/msm.md#source-blueprints-and-blueprint-configurations)modelo) especifica las páginas desde las que una Live Copy puede heredar contenido.
...
1. Abra la consola **Herramientas** en la IU clásica; por ejemplo, [http://localhost:4502/miscadmin#/etc](http://localhost:4502/miscadmin#/etc)
