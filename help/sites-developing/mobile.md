...
* [com.day.cq.wcm.mobile.api](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/mobile/api/device/capability/package-summary.html) - define las constantes móviles.
...
AEM utiliza una versión truncada de la base de datos [WURFL](http://wurfl.sourceforge.net/index.php)™ para consulta de las capacidades del dispositivo, como la resolución de pantalla o la compatibilidad con javascript, según el agente de usuario del dispositivo.
...
>[!NOTE]
>
>Para obtener más información, lea la sección [Custom BrowserMap](#using-browsermap-on-your-pages).
