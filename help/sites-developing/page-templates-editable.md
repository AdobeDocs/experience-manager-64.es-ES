...
>[!NOTE]
>
>Se requiere AEM 6.4.5.0 o posterior para utilizar plantillas editables con el Editor [de](/help/sites-developing/spa-overview.md)SPA.
...
* Modelo: paquetes OSGi
   ...
   Los paquetes [](/help/sites-deploying/osgi-configuration-settings.md) OSGI implementan la funcionalidad.

* Ver - `/apps/<my-site>/components`

   Tanto en el entorno de creación como en el de publicación, el contenido lo representan [los componentes](/help/sites-developing/components.md).
