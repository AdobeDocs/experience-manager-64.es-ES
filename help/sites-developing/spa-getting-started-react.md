...
La `Page` ingesta la representación JSON del modelo de página y procesa el contenido para ajustar/decorar cada elemento de la página. Para más información sobre el `Page` tema, véase el documento [SPA Blueprint](/help/sites-developing/spa-blueprint.md).
...
Para obtener más información, consulte el documento [Modelo de SPA](/help/sites-developing/spa-blueprint.md).
