...
representación. A continuación, el modelo, representado como JSON, se procesa utilizando las asignaciones de componentes dentro de un contenedor.\
...
El SDK del Editor de AEM SPA se ha introducido con el Service Pack 2 de AEM 6.4. Adobe lo admite plenamente y, como nueva función, se sigue ampliando y mejorando. El Editor de SPA aún no ha cubierto las siguientes funciones de AEM:
