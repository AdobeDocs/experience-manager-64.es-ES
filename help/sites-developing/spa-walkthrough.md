...
1. Cargue el `react.model.json` en una pestaña nueva.
   ...
   El AEM SPA Editor aprovecha [Servicios de contenido AEM](/help/assets/content-fragments.md) para entregar todo el contenido de la página como un modelo JSON.
