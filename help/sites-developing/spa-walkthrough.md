...
1. Cargue la aplicación We.Retail Journal en el servidor de publicación o con la opción **[!UICONTROL Ver como publicado]** del menú Información **de** página del editor de páginas.
...
1. Si aún no se ha cargado, cargue la aplicación We.Retail Journal en el servidor de publicación o con la opción **[!UICONTROL Ver como publicado]** del menú Información **de** página del editor de páginas.
