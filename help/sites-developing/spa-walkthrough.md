...
1. Cargue la aplicación de Historial We.Retail en el servidor de publicación o utilizando la opción **[!UICONTROL Vista tal y como se publica]** del menú **Información de página** del editor de páginas.
...
1. Si aún no se ha cargado, cargue la aplicación de Historial We.Retail en el servidor de publicación o utilizando la opción **[!UICONTROL Vista tal y como se publica]** del menú **Información de página** del editor de páginas.
