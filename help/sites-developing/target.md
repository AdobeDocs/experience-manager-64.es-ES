...
* Para obtener información sobre la creación de contenido de destino, consulte [Creación de contenido de destino mediante el modo de Orientación](/help/sites-authoring/content-targeting-touch.md).
...
1. Vaya a CQ **Herramientas** página y seleccione **Cloud Services**. ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))
...
La configuración de Target incluye un archivo mbox.js personalizado, [el código requerido en la sección del encabezado](/help/sites-developing/target.md#the-head-section) de su página agrega el archivo al marco de biblioteca del cliente en lugar de una referencia a la biblioteca testandtarget.js .
...
Los valores de cada parámetro son diferentes para cada orden. Por lo tanto, es necesario un componente que genere el código en función de las propiedades de la compra. CQ [eCommerce Integration Framework](/help/sites-administering/ecommerce.md) le permite integrarse con su catálogo de productos e implementar un carro de compras y una página de cierre de compra.
