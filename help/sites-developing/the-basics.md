...
Con AEM, un entorno de producción a menudo consta de dos tipos diferentes de instancias: an [Creación y publicación de instancias](/help/sites-deploying/deploy.md#author-and-publish-installs).
