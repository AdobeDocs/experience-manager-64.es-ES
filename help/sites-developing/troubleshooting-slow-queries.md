...
1. ***Este ajuste es específico de Query Builder y no se aplica a JCR-SQL2 o XPath.***
   ...
   Utilice [Query Builder&#39; GuessTotal](/help/sites-developing/querybuilder-api.md#using-p-guesstotal-to-return-the-results) cuando el conjunto completo de resultados sea **no **inmediatamente necesario.
