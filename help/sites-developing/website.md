---
title: Crear un sitio web con todas las características (JSP)
...
>[!CAUTION]
>
>Este artículo describe cómo crear un sitio web utilizando JSP y basado en la IU clásica. Adobe recomienda aprovechar las últimas tecnologías de AEM para sus sitios web como se describe detalladamente en el artículo [Introducción al desarrollo de AEM Sites](/help/sites-developing/getting-started.md).
...
1. Instalar AEM.
1. CRXDE Lite de acceso (entorno de desarrollo).
...
Para seguir el tutorial en lugar de realizar los ejercicios, descargue el sitio web-1.0.zip. Este archivo es un paquete de contenido AEM que contiene los resultados de este tutorial. Uso [Administrador de paquetes](/help/sites-administering/package-manager.md) para instalar el paquete en la instancia de autor.
...
Para instalar una instancia de AEM para desarrollar su sitio web, siga las instrucciones para configurar una [entorno de implementación con instancias de autor y publicación](/help/sites-deploying/deploy.md#author-and-publish-installs)o realizar una [instalación genérica](/help/sites-deploying/deploy.md#default-local-install). La instalación genérica implica descargar el archivo JAR de inicio rápido AEM, colocar el archivo license.properties en el mismo directorio que el archivo JAR y hacer doble clic en el archivo JAR.
...
>[!NOTE]
>
>La URL del CRXDE Lite para una instancia de creación de AEM que se instala localmente mediante el puerto predeterminado es [http://localhost:4502/crx/de/](http://localhost:4502/crx/de/).
...
1. En el árbol de la parte izquierda del CRXDE Lite, haga clic con el botón derecho en la variable **`/apps`** carpeta y haga clic en **[!UICONTROL Crear > Crear carpeta]**. En el **Crear carpeta** cuadro de diálogo, tipo `mywebsite` como nombre de la carpeta y haga clic en **OK**.
1. Haga clic con el botón derecho en el `/apps/mywebsite` carpeta y haga clic en **[!UICONTROL Crear > Crear carpeta]**. En el **[!UICONTROL Crear carpeta]** cuadro de diálogo, tipo `components` como nombre de la carpeta y haga clic en **[!UICONTROL OK]**.
1. Haga clic con el botón derecho en el `/apps/mywebsite` carpeta y haga clic en **[!UICONTROL Crear > Crear carpeta]**. En el **[!UICONTROL Crear carpeta]** cuadro de diálogo, tipo `templates` como nombre de la carpeta y haga clic en **[!UICONTROL OK]**.
...
1. En el árbol de carpetas, seleccione la **[!UICONTROL Diseños]** carpeta y, a continuación, haga clic en **[!UICONTROL Nuevo > Nueva página]**. Tipo `mywebsite` como título y haga clic en **[!UICONTROL Crear]**.

1. Si el elemento mywebsite no aparece en la tabla, actualice el árbol o la tabla.

1. [Uso de WebDAV](/help/sites-administering/webdav-access.md) acceso a la URL en http://localhost:4502, copie el ejemplo `static.css` y `images` desde el archivo mywebsite.zip descargado al `/etc/designs/mywebsite` carpeta.
...
1. En el árbol de carpetas del CRXDE Lite, haga clic con el botón derecho del ratón `/apps/mywebsite/templates` y haga clic en **[!UICONTROL Crear > Crear plantilla]**.
...
1. Para especificar las rutas de las páginas que pueden utilizar esta plantilla, haga clic en el botón más y escriba `/content(/.*)?` en el cuadro de texto que aparece. A continuación, haga clic en **[!UICONTROL Siguiente]**.
   ...
   Cuando un autor crea una página a continuación `/content`, el **[!UICONTROL contentpage]** aparece en una lista de plantillas disponibles para usar.

1. Haga clic en **[!UICONTROL Siguiente]** en el **[!UICONTROL Principales permitidos]** y **[!UICONTROL Niños permitidos]** paneles y haga clic en **[!UICONTROL OK]**. En el CRXDE Lite, haga clic en **[!UICONTROL Guardar todo]**.
...
1. En el **[!UICONTROL Crear componente]** , escriba los siguientes valores de propiedad:

   * **[!UICONTROL Etiqueta]**: contentpage
   * **[!UICONTROL Título]**: Componente de la página de contenido de Mi sitio web
   * **[!UICONTROL Descripción]**: Este es el componente de la página de contenido de mi sitio web
...
1. Haga clic en **[!UICONTROL Siguiente]** hasta que **[!UICONTROL Niños permitidos]** del cuadro de diálogo y, a continuación, haga clic en **[!UICONTROL OK]**. En el CRXDE Lite, haga clic en **[!UICONTROL Guardar todo]**.
...
1. En el árbol de carpetas, seleccione la **[!UICONTROL Sitios web]** carpeta y, a continuación, haga clic en **[!UICONTROL Nuevo > Nueva página]**.
1. En el **[!UICONTROL Crear página]** , introduzca lo siguiente:

   * **[!UICONTROL Título]**: `My Website`
   * **[!UICONTROL Nombre]**: `mywebsite`
   * Seleccione el **[!UICONTROL Plantilla de página de contenido de Mi sitio web]**

   ![chlimage_1-110](assets/chlimage_1-110.png)

1. Haga clic en **[!UICONTROL Crear]**. En el árbol de carpetas, seleccione la `/Websites/My Website` página y haga clic en **[!UICONTROL Nuevo > Nueva página]**.
1. En el **[!UICONTROL Crear página]** , introduzca los siguientes valores de propiedad y haga clic en Crear:

   * **[!UICONTROL Título]**: Inglés
   * **[!UICONTROL Nombre]**: en
   * Seleccione el **[!UICONTROL Plantilla de página de contenido de Mi sitio web]**

1. En el árbol de carpetas, seleccione la `/Websites/My Website/English` página y haga clic en **[!UICONTROL Nuevo > Nueva página]**.
1. En el **[!UICONTROL Crear página]** , introduzca los siguientes valores de propiedad y haga clic en **[!UICONTROL Crear]**:
...
1. Para vincular las páginas al diseño de mywebsite, en CRXDE Lite, seleccione la opción `/content/mywebsite/en/jcr:content` nodo . En el **[!UICONTROL Propiedades]** , escriba los siguientes valores para una nueva propiedad y haga clic en Agregar:
...
1. En una nueva pestaña o ventana del explorador web, abra [http://localhost:4502/content/mywebsite/en/products.html](http://localhost:4502/content/mywebsite/en/products.html) para ver la página Productos :
...
La variable **[!UICONTROL Productos]** La página tendrá el siguiente aspecto:
...
1. En el CRXDE Lite, agregue una propiedad a la variable `/apps/mywebsite/components/contentpage` nodo .
   ...
   1. En la parte inferior de la ficha Propiedades, escriba los siguientes valores de propiedad y haga clic en Agregar:
...
1. Abra el `contentpage.jsp` file under `/apps/mywebsite/components/contentpage` y reemplace el código existente por el siguiente código:
...
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** página. Tiene el siguiente aspecto:
...
1. En el CRXDE Lite, cree el archivo . `left.jsp` under `/apps/mywebsite/components/contentpage`:
   ...
   1. Haga clic con el botón derecho en el nodo `/apps/mywebsite/components/contentpage`y, a continuación, seleccione **[!UICONTROL Crear]** then **[!UICONTROL Crear archivo]**.
   1. En la ventana , escriba `left.jsp` como** Nombre** y haga clic en **[!UICONTROL OK]**.

1. Editar el archivo `left.jsp` para eliminar el contenido existente y sustituirlo por el siguiente código:
...
1. Guarde los cambios.
1. En el CRXDE Lite, cree el archivo . `center.jsp` under `/apps/mywebsite/components/contentpage`:

   1. Haga clic con el botón derecho en el nodo `/apps/mywebsite/components/contentpage`, seleccione **[!UICONTROL Crear]**, luego **[!UICONTROL Crear archivo]**.
   1. En el cuadro de diálogo, escriba `center.jsp` como **[!UICONTROL Nombre]** y haga clic en **[!UICONTROL OK]**.

1. Editar el archivo `center.jsp` para eliminar el contenido existente y sustituirlo por el siguiente código:
...
1. Guarde los cambios.
1. En el CRXDE Lite, cree el archivo . `right.jsp` under `/apps/mywebsite/components/contentpage`:

   1. Haga clic con el botón derecho en el nodo `/apps/mywebsite/components/contentpage`, seleccione **[!UICONTROL Crear]**, luego **[!UICONTROL Crear archivo]**.
   1. En el cuadro de diálogo, escriba `right.jsp` como **[!UICONTROL Nombre]** y haga clic en **[!UICONTROL OK]**.

1. Editar el archivo `right.jsp` para eliminar el contenido existente y sustituirlo por el siguiente código:
...
1. Guarde los cambios.
1. En el CRXDE Lite, cree el archivo . `body.jsp` under `/apps/mywebsite/components/contentpage`:
1. Editar el archivo `body.jsp` para eliminar el contenido existente y sustituirlo por el siguiente código:
...
1. En el CRXDE Lite, haga clic con el botón derecho `/apps/mywebsite/components`, seleccione **[!UICONTROL Crear]**, luego **[!UICONTROL Crear componente]**.
1. En el **[!UICONTROL Crear componente]** , introduzca lo siguiente:
...
1. Haga clic en **[!UICONTROL Siguiente]** hasta que llegue a la última ventana en la que hace clic **[!UICONTROL OK]**. Guarde los cambios.

#### Creación del script de navegación superior con vínculos textuales {#creating-the-top-navigation-script-with-textual-links}
...
1. Reemplace el código que se encuentra allí copiando y pegando el siguiente código:
...
1. En el CRXDE Lite, abra el `body.jsp` under `/apps/mywebsite/components/contentpage`y reemplace:
...
1. Guarde los cambios.
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** Página. La navegación superior aparece de la siguiente manera:

   ![chlimage_1-115](assets/chlimage_1-115.png)

#### Mejora de páginas con subtítulos {#enhancing-pages-with-subtitles}

La variable **[!UICONTROL Página]** define propiedades que permiten proporcionar subtítulos para páginas. Agregue subtítulos que proporcionen información sobre el contenido de la página.

1. En el navegador, abra la **[!UICONTROL Productos]** página.
1. En la barra de tareas **[!UICONTROL Página]** , haga clic en **[!UICONTROL Propiedades de página]**.
1. En el **[!UICONTROL Básico]** del cuadro de diálogo, expanda **[!UICONTROL Más títulos y descripción]** y para **[!UICONTROL Subtítulo]** propiedad, tipo `what we do`. Haga clic en **[!UICONTROL Aceptar]**.
1. Repita los pasos anteriores para agregar el subtítulo **acerca de nuestros servicios** a **[!UICONTROL Servicios]** página.
1. Repita los pasos anteriores para agregar el subtítulo **la confianza que ganamos** a **[!UICONTROL Clientes]** página.
...
Este ejercicio demuestra [Procesamiento de solicitudes de Sling](/help/sites-developing/the-basics.md#sling-request-processing). El script topnav.jsp se modifica para llamar a un script que genere dinámicamente imágenes para utilizarlas en los vínculos de navegación de la página. En este ejercicio, Sling analiza la dirección URL de los archivos de origen de imagen para determinar el script que se utilizará para procesar las imágenes.
...
1. Sling coincide con esta ruta con el `/content/mywebsite/en/products` nodo .
1. Sling determina `sling:resourceType` de este nodo que se va a `mywebsite/components/contentpage`.

1. Sling encuentra el script de este componente que mejor se ajusta al selector de URL ( `navimage`) y extensión de nombre de archivo ( `png`).
...
1. Sustituya el contenido de anclaje por el siguiente código:
...
1. Guarde los cambios.
1. Haga clic con el botón derecho en el `/apps/mywebsite/components/contentpage` nodo y haga clic en **[!UICONTROL Crear > Crear archivo]**.
1. En el **[!UICONTROL Crear archivo]** como **[!UICONTROL Nombre]**, tipo `navimage.png.java`.
...
1. Copie el siguiente código en `navimage.png.java.`El código amplía la clase AbstractImageServlet :
   ...
   * [AbstractImageServlet](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.html) crea un objeto ImageContext que almacena las propiedades del recurso actual.
   ...
   * [ImageHelper](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/commons/ImageHelper.html) se utiliza para generar la imagen a partir del archivo navimage_bg.jpg del diseño del sitio, el título de la página y el subtítulo de la página.
...
1. Guarde los cambios.
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** página. La navegación superior ahora aparece de la siguiente manera:
...
Cree dos páginas debajo de la variable **[!UICONTROL Productos]** página. Para cada página, que describe dos productos específicos, se establece un título, una descripción y una fecha.

1. En el árbol de carpetas del **[!UICONTROL Sitios web]** seleccione **[!UICONTROL Sitios web/Mi sitio web/Inglés/Productos]** elemento y haga clic en **[!UICONTROL Nuevo > Nueva página]**.
1. En el cuadro de diálogo, introduzca los siguientes valores de propiedad y haga clic en **[!UICONTROL Crear]**:
   ...
   * Select **[!UICONTROL Plantilla de página de contenido de Mi sitio web]**

1. Cree otra página debajo de Productos con los siguientes valores de propiedad:

   * **[!UICONTROL Título]**: Product 2
...
1. En CRXDE Lite, establezca una descripción y una fecha para la página Product 1:
   ...
   1. En el **[!UICONTROL Propiedades]** , introduzca los siguientes valores:

      * **[!UICONTROL Nombre]**: `jcr:description`
      * **[!UICONTROL Tipo]**: `String`
      * **[!UICONTROL Valor]**: `This is a description of the Product 1!.`
   1. Haga clic en **[!UICONTROL Agregar]**.
   1. En el **[!UICONTROL Propiedades]** , cree otra propiedad con los siguientes valores:

      * **[!UICONTROL Nombre]**: date
      * **[!UICONTROL Tipo]**: Cadena
      * **[!UICONTROL Valor]**: 14/2/2008
...
1. En el cuadro de diálogo, introduzca los siguientes valores de propiedad y haga clic en **[!UICONTROL Siguiente]**:
   ...
   * **[!UICONTROL Descripción]**: Este es mi componente Listchildren.

1. Siga haciendo clic en **[!UICONTROL Siguiente]** hasta que **[!UICONTROL Niños permitidos]** y haga clic en **[!UICONTROL OK]**.
...
1. Cree el nodo de diálogo en el componente listchildren:
   ...
   1. En el CRXDE Lite, haga clic con el botón derecho en el `/apps/mywebsite/components/listchildren`nodo y haga clic en **[!UICONTROL Crear > Crear cuadro de diálogo]**.
   1. En el cuadro de diálogo, introduzca los siguientes valores de propiedad y haga clic en Aceptar

      * **[!UICONTROL Etiqueta]**: `dialog`
      * **[!UICONTROL Título]**: `Edit Component` y haga clic en **[!UICONTROL OK]**.
...
1. En el **[!UICONTROL Propiedades]** , cambie el valor de la pestaña **[!UICONTROL title]** propiedad a `List Children`

   ![chlimage_1-117](assets/chlimage_1-117.png)

1. Seleccione el **tab1** nodo y haga clic en **[!UICONTROL Crear > Crear nodo]**, introduzca los siguientes valores de propiedad y haga clic en **[!UICONTROL OK]**:

   * **[!UICONTROL Nombre]**: items
   * **[!UICONTROL Tipo]**: cq:WidgetCollection

   ![screen_shot_2012-03-07at51018pm](assets/screen_shot_2012-03-07at51018pm.png)

1. Cree un nodo debajo del nodo elementos utilizando los siguientes valores de propiedad:
...
1. Agregue propiedades para el nodo listroot para configurarlo como un campo de texto. Cada fila de la tabla siguiente representa una propiedad. Cuando termine, haga clic en **[!UICONTROL Guardar todo]**.
...
1. Reemplace ese código por el siguiente código:
...
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** página. El componente listchildren aparece de la siguiente manera:

   ![chlimage_1-118](assets/chlimage_1-118.png)

1. ![chlimage_1-119](assets/chlimage_1-119.png)

1. Como Ruta de la raíz de la lista, introduzca: `/content/mywebsite/en`. Haga clic en **[!UICONTROL Aceptar]**. El componente listchildren de su página ahora tiene el siguiente aspecto:

   ![chlimage_1-120](assets/chlimage_1-120.png)

### Creación del componente de logotipo {#creating-the-logo-component}

Cree un componente que muestre el logotipo de la empresa y proporcione un vínculo a la página principal del sitio. El componente contiene un cuadro de diálogo en modo de diseño para que los valores de las propiedades se almacenen en el diseño del sitio (/etc/designs/mywebsite):
...
1. En el CRXDE Lite, haga clic con el botón derecho del ratón en /apps/mywebsite/components, seleccione **[!UICONTROL Crear]**, luego **[!UICONTROL Crear componente]**.
...
1. Haga clic en Siguiente hasta que llegue al panel final del cuadro de diálogo y, a continuación, haga clic en **[!UICONTROL OK]**.
...
1. El siguiente código crea el vínculo a la página principal del sitio y agrega una referencia a la imagen del logotipo. Copie el código a `logo.jsp`:
...
1. Cree el nodo de diálogo en el componente logotipo:
   ...
   1. Haga clic con el botón derecho en el `/apps/mywebsite/components/logo` nodo y haga clic en **[!UICONTROL Crear > Crear cuadro de diálogo]**.
   1. Escriba los siguientes valores de propiedad y haga clic en **[!UICONTROL OK]**:

      * **[!UICONTROL Etiqueta]** `design_dialog`
      * **[!UICONTROL Título]** `Logo (Design)`

1. Haga clic con el botón derecho en el nodo tab1 de la rama design_dialog y haga clic en Delete. Haga clic en **[!UICONTROL Guardar todo]**.
1. En el `design_dialog/items/items`nodo, crear un nuevo nodo denominado `img` de tipo `cq:Widget`. Agregue las siguientes propiedades y haga clic en **[!UICONTROL Guardar todo]**:
...
1. Haga clic con el botón derecho del ratón en el nodo de componente del logotipo y haga clic en **[!UICONTROL Crear > Crear archivo]** para crear el archivo de script llamado img.GET.java.
1. Abra el archivo , copie el siguiente código en el archivo y, a continuación, haga clic en **[!UICONTROL Guardar todo]**:
...
1. Guarde los cambios.
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** página. El logotipo tiene el siguiente aspecto, aunque actualmente solo muestra el vínculo subyacente:
...
1. Con la variable **[!UICONTROL Productos]** abra una página en el explorador y haga clic en la **[!UICONTROL Diseño]** en la parte inferior de la barra de tareas para entrar **[!UICONTROL Diseño]** en el menú contextual.

   ![](do-not-localize/chlimage_1-10.png)

1. En la barra Diseño del logotipo, haga clic en **[!UICONTROL Editar]** para utilizar el cuadro de diálogo para editar la configuración del componente del logotipo.
1. En el cuadro de diálogo, haga clic en en el panel de la **[!UICONTROL Imagen]** , busque `logo.png` imagen extraída del `mywebsite.zip` y haga clic en **[!UICONTROL OK]**.

   ![chlimage_1-124](assets/chlimage_1-124.png)

1. Haga clic en el triángulo de la barra de título de la barra de tareas para volver a **[!UICONTROL Editar]** en el menú contextual.

   ![Chlimage_1-7](assets/chlimage_1-7.jpeg)

1. En CRXDE Lite, vaya al nodo siguiente para ver los valores de las propiedades almacenadas:
...
1. Guarde los cambios.
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos 1]** página. El componente de pista tiene el siguiente aspecto:
...
1. Guarde los cambios.
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** página. El componente de título tiene el siguiente aspecto:

   ![chlimage_1-126](assets/chlimage_1-126.png)

>[!NOTE]
>Puede establecer un título diferente y el tipo o tamaño en **[!UICONTROL Editar]** en el menú contextual.
...
1. En el explorador, actualice la variable **[!UICONTROL Productos]** página. Ahora tiene el componente parsys, que se ve de la siguiente manera:
...
1. Haga clic con el botón derecho en la variable `/apps/mywebsite/components/logo` nodo y haga clic en **[!UICONTROL Copiar]**.
1. Haga clic con el botón derecho en el `/apps/mywebsite/components` nodo y haga clic en **[!UICONTROL Pegar]**.
1. Haga clic con el botón derecho en el `Copy of logo` nodo, haga clic en **[!UICONTROL Cambiar nombre]**, elimine el texto existente y escriba `image`.
...
1. Debajo de `image` nodo, cambie el nombre del `design_dialog` nodo a `dialog`.

1. Cambiar nombre `logo.jsp` a `image.jsp.`
...
1. En el nodo cq:editConfig, cree un nuevo nodo de la siguiente manera:

   * **[!UICONTROL Nombre]**: cq:dropTargets.
   * **[!UICONTROL Tipo]**: cq:DropTargetConfig

1. Bajo el nodo cq:dropTargets, cree un nuevo nodo de la siguiente manera:

   * **[!UICONTROL Nombre]**: imagen.
   * **[!UICONTROL Tipo]**: nt:unstructured.

1. En CRXDE, defina las propiedades como se indica a continuación:
...
1. En el CRXDE Lite, haga clic con el botón derecho en el archivo `/libs/foundation/components/image/icon.png` y seleccione **[!UICONTROL Copiar]**.
1. Haga clic con el botón derecho en el nodo `/apps/mywebsite/components/image` y haga clic en **[!UICONTROL Pegar]** y haga clic en **[!UICONTROL Guardar todo]**.

#### Uso del componente de imagen {#using-the-image-component}

En esta sección, verá la **[!UICONTROL Productos]** y añada el componente de imagen al sistema de párrafos.

1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** página.
1. En la barra de tareas, haga clic en la **[!UICONTROL Modo de diseño]** icono.
1. Haga clic en el **[!UICONTROL Editar]** para editar el cuadro de diálogo de diseño de par.
1. En el cuadro de diálogo, una lista de **[!UICONTROL Componentes permitidos]** se muestra; vaya a **[!UICONTROL MyWebsite]**, seleccione **[!UICONTROL Componente Mi imagen]** y haga clic en **[!UICONTROL OK]**.
1. Volver a **[!UICONTROL Modo de edición]**.
1. Haga doble clic en el marco parsys (en **[!UICONTROL Arrastrar componentes o recursos aquí]**). La variable **[!UICONTROL Insertar nuevo componente]** y **[!UICONTROL Barra de tareas]** los selectores tienen el siguiente aspecto:
...
1. Reemplace ese código por el siguiente código y, a continuación, guarde los cambios.

   ```java
   <cq:include path="toolbar" resourceType="foundation/components/toolbar"/>
   ```

1. En el árbol de carpetas de la página AEM Sitios web, seleccione `Websites/My Website/English`y haga clic en **[!UICONTROL Nuevo > Nueva página]**. Especifique los siguientes valores de propiedad y haga clic en Crear:

   * **[!UICONTROL Título]**: Barra de herramientas
   * Select **[!UICONTROL Plantilla de página de contenido de Mi sitio web]**

1. En la lista de páginas, haga clic con el botón derecho en la variable **[!UICONTROL Barra de herramientas]** página y haga clic en **[!UICONTROL Propiedades]**. Select **[!UICONTROL Ocultar en navegación]** y haga clic en **[!UICONTROL OK]**.

   La variable **[!UICONTROL Ocultar en navegación]** evita que la página aparezca en los componentes de navegación, como topnav y listchildren.
...
El cuadro de entrada de búsqueda tendrá el siguiente aspecto en la sección **[!UICONTROL Inglés]** página:
...
1. Utilice el cuadro de diálogo para configurar el componente:
   ...
   1. Haga clic en **[!UICONTROL Siguiente]** y haga clic en **[!UICONTROL Siguiente]** de nuevo.
   1. En el **[!UICONTROL Principales permitidos]** , haga clic en el **[!UICONTROL +]** botón y tipo `*/parsys`.
   1. Haga clic en **[!UICONTROL Siguiente]** y haga clic en **[!UICONTROL OK]**.


1. Haga clic en **[!UICONTROL Guardar todo]**.
1. Copie los siguientes nodos y péguelos en el `apps/mywebsite/components/search` nodo:
...
1. Copie el siguiente código a `search.jsp`:
...
1. Inserte el siguiente código *before* esa línea:
...
1. Busque la línea de código siguiente:
...
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** página. El componente de búsqueda tiene el siguiente aspecto:
...
1. En la barra de tareas, haga clic en la **[!UICONTROL Diseño]** icono de modo.
1. En el bloque Diseño de par (debajo del título de búsqueda), haga clic en **[!UICONTROL Editar]**.
1. En el cuadro de diálogo, desplácese hacia abajo hasta el **[!UICONTROL Mis sitios web]** grupo, seleccione **[!UICONTROL Mi componente de búsqueda]** y haga clic en **[!UICONTROL OK]**.
1. En la barra de tareas, haga clic en el triángulo para volver a **[!UICONTROL Editar]** en el menú contextual.
1. Arrastre el **[!UICONTROL Mi búsqueda]** desde la barra de tareas hasta el marco parsys. Tiene el siguiente aspecto:

   ![chlimage_1-133](assets/chlimage_1-133.png)

1. Vaya a la **[!UICONTROL Productos]** página. Busque clientes en el cuadro de entrada y pulse **[!UICONTROL Entrar]**. Se le redirige a la función **[!UICONTROL Buscar]** página. Cambie a **[!UICONTROL Vista previa]** modo: la salida tiene un formato similar al siguiente:
...
1. Guarde los cambios.
1. En el explorador, vuelva a cargar la variable **[!UICONTROL Productos]** página. La página completa tiene el siguiente aspecto:
