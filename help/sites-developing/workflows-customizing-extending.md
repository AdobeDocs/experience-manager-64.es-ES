...
1. Aplique las siguientes propiedades al nodo:
   ...
   * `cq:icon`
      ...
      Se utiliza para especificar un icono [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/coral-ui/coralui3/Coral.Icon.html) Coral para el paso.
